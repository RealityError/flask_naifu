  ...
  [888],
  {
    ...
    1193: function (e, t) {
      !(function (e) {
            ...
            e.forEach(function (a, u) {
              if (i) {
                ...
                t.forEach(function (i, f) {
                  c ||
                    o[l] ||
                    ((c = n(u, f, s, l, e, t, r) && n(a, i, u, f, e, t, r)) &&
                      (o[l] = !0)),
                    l++;
                }),
                  s++,
        ...
        var S = w(),
          ...
          _ = w(c()),
          k = w(c(r));
        (e.circularDeepEqual = _),
          (e.circularShallowEqual = k),
    ...
    8253: function (e) {
      ...
      ((t.Diff = function (e, t) {
        ...
        (t.Diff.prototype.toString = function () {
        ...
        (t.prototype.diff_main = function (e, n, r, i) {
          ...
          return (
            u && l.unshift(new t.Diff(0, u)),
            c && l.push(new t.Diff(0, c)),
        ...
        (t.prototype.diff_compute_ = function (e, r, i, o) {
          ...
          if (-1 != c)
            return (
              (s = [
                new t.Diff(1, a.substring(0, c)),
                new t.Diff(0, u),
                new t.Diff(1, a.substring(c + u.length)),
              ]),
            ...
            switch (a[u][0]) {
              ...
              case 0:
                if (c >= 1 && l >= 1) {
                  ...
                  for (
                    var d = this.diff_main(f, h, !1, i), p = d.length - 1;
                    p >= 0;
                    p--
                  )
                    a.splice(u, 0, d[p]);
        ...
        (t.prototype.diff_bisect_ = function (e, r, i) {
          ...
          (l[u + 1] = 0), (f[u + 1] = 0);
          for (
            var d = o - s, p = d % 2 != 0, g = 0, v = 0, y = 0, m = 0, b = 0;
            b < a && !(new Date().getTime() > i);
            b++
          ) {
            for (var w = -b + g; w <= b - v; w += 2) {
              ...
              if (((l[S] = A), A > o)) v += 2;
                ...
                if ((T = u + d - w) >= 0 && T < c && -1 != f[T])
                  if (A >= (k = o - f[T]))
                    return this.diff_bisectSplit_(e, r, A, x, i);
              }
            }
                  ...
                  E =
                    (k =
                      _ == -b || (_ != b && f[T - 1] < f[T + 1])
                        ? f[T + 1]
                        : f[T - 1] + 1) - _;
                k < o && E < s && e.charAt(o - k - 1) == r.charAt(s - E - 1);
        ...
        (t.prototype.diff_linesToChars_ = function (e, t) {
          ...
          function i(e) {
            for (var t = "", i = 0, s = -1, a = n.length; s < e.length - 1; ) {
              ...
              (r.hasOwnProperty ? r.hasOwnProperty(u) : void 0 !== r[u])
                ...
                : (a == o && ((u = e.substring(i)), (s = e.length)),
          ...
          var o = 4e4,
            s = i(e);
          return (o = 65535), { chars1: s, chars2: i(t), lineArray: n };
        }),
        ...
        (t.prototype.diff_commonOverlap_ = function (e, t) {
          ...
          for (var o = 0, s = 1; ; ) {
            ...
            if (-1 == u) return o;
            (s += u),
              (0 != u && e.substring(i - s) != t.substring(0, s)) ||
                ((o = s), s++);
          }
        }),
        (t.prototype.diff_halfMatch_ = function (e, t) {
          ...
          function o(e, t, n) {
            for (
              ...
              l.length < h + f &&
                ((l = t.substring(c - h, c) + t.substring(c, c + f)),
                (r = e.substring(0, n - h)),
                (o = e.substring(n + f)),
                (s = t.substring(0, c - h)),
                (a = t.substring(c + f)));
          ...
          return f || h
            ? ((s = h ? (f && f[4].length > h[4].length ? f : h) : f),
              e.length > t.length
                ? ((a = s[0]), (u = s[1]), (c = s[2]), (l = s[3]))
                : ((c = s[0]), (l = s[1]), (a = s[2]), (u = s[3])),
              [a, u, c, l, s[4]])
            : null;
        }),
        (t.prototype.diff_cleanupSemantic = function (e) {
          for (
            ...
            0 == e[a][0]
              ? ((i[o++] = a),
                ...
                (f = 0),
                (s = e[a][1]))
              : (1 == e[a][0] ? (l += e[a][1].length) : (f += e[a][1].length),
                s &&
                  s.length <= Math.max(u, c) &&
                  s.length <= Math.max(l, f) &&
                  (e.splice(i[o - 1], 0, new t.Diff(n, s)),
                  (e[i[o - 1] + 1][0] = 1),
                  o--,
                  (a = --o > 0 ? i[o - 1] : -1),
                  (u = 0),
          ...
          for (
            ...
            if (e[a - 1][0] == n && 1 == e[a][0]) {
              ...
              p >= g
                ? (p >= h.length / 2 || p >= d.length / 2) &&
                  (e.splice(a, 0, new t.Diff(0, d.substring(0, p))),
                  (e[a - 1][1] = h.substring(0, h.length - p)),
                  (e[a + 1][1] = d.substring(p)),
                  a++)
                : (g >= h.length / 2 || g >= d.length / 2) &&
                  (e.splice(a, 0, new t.Diff(0, h.substring(0, g))),
                  (e[a - 1][0] = 1),
        ...
        (t.prototype.diff_cleanupEfficiency = function (e) {
          for (
            ...
            0 == e[a][0]
              ? (e[a][1].length < this.Diff_EditCost && (l || f)
                  ? ((i[o++] = a), (u = l), (c = f), (s = e[a][1]))
                  : ((o = 0), (s = null)),
                (l = f = !1))
              : (e[a][0] == n ? (f = !0) : (l = !0),
                s &&
        ...
        (t.prototype.diff_toDelta = function (e) {
          for (var t, r = [], i = 0; i < e.length; i++) {
            ...
            if (
              0 !== o[1].length &&
              (a &&
                this.isHighSurrogate(a) &&
                ((t = a), (o[1] = o[1].slice(0, -1))),
              t &&
                s &&
                this.isHighSurrogate(t) &&
                this.isLowSurrogate(s) &&
                (o[1] = t + o[1]),
              0 !== o[1].length)
            )
              switch (o[0]) {
              ...
              if ("%" === e[t]) {
                ...
                if (0 !== (128 & r)) {
                  ...
                  if (((i &= 63), 192 !== (224 & r))) {
                    ...
                    (n += String.fromCharCode(((15 & r) << 12) | (i << 6) | o)),
                      (t += 9);
                  } else
                    (n += String.fromCharCode(((31 & r) << 6) | i)), (t += 6);
          ...
          for (
            ...
            switch (a[u].charAt(0)) {
              ...
              default:
                if (a[u])
                  throw new Error(
                    "Invalid diff operation in diff_fromDelta: " + a[u]
                  );
            }
          }
          if (s != e.length)
        ...
        (t.prototype.match_bitap_ = function (e, t, n) {
          ...
          -1 != a &&
            ((s = Math.min(o(0, a), s)),
            -1 != (a = e.lastIndexOf(t, n + t.length)) &&
              (s = Math.min(o(0, a), s)));
          var u,
            c,
            l = 1 << (t.length - 1);
          ...
          for (
            ...
            switch ((c || 0 === g || ((u.start1 = l), (u.start2 = f)), g)) {
              case 1:
                (u.diffs[c++] = s[p]),
                  (u.length2 += v.length),
                  (d = d.substring(0, f) + v + d.substring(f));
                break;
              case n:
                (u.length1 += v.length),
                  (u.diffs[c++] = s[p]),
                  (d = d.substring(0, f) + d.substring(f + v.length));
                break;
              case 0:
                v.length <= 2 * this.Patch_Margin && c && s.length != p + 1
                  ? ((u.diffs[c++] = s[p]),
                    (u.length1 += v.length),
                    (u.length2 += v.length))
                  : v.length >= 2 * this.Patch_Margin &&
                    c &&
                    (this.patch_addContext_(u, h),
                    a.push(u),
                    (u = new t.patch_obj()),
                    (c = 0),
                    (h = d),
              ...
              (l.length > this.Match_MaxBits
                ? -1 !=
                  ...
                  (-1 ==
                    ...
                    a >= f) &&
                  (a = -1)
                : (a = this.match_main(t, l, c)),
              -1 == a)
            )
              (o[s] = !1), (i -= e[s].length2 - e[s].length1);
            else if (
              ((o[s] = !0),
              (i = a - c),
              l ==
                (u =
                  -1 == f
                    ? t.substring(a, a + l.length)
                    : t.substring(a, f + this.Match_MaxBits)))
            )
              t =
                t.substring(0, a) +
                this.diff_text2(e[s].diffs) +
                t.substring(a + l.length);
            else {
              var h = this.diff_main(l, u, !1);
              if (
                l.length > this.Match_MaxBits &&
                this.diff_levenshtein(h) / l.length > this.Patch_DeleteThreshold
              )
                o[s] = !1;
              else {
                ...
                for (var d, p = 0, g = 0; g < e[s].diffs.length; g++) {
                  var v = e[s].diffs[g];
                  0 !== v[0] && (d = this.diff_xIndex(h, p)),
                    1 === v[0]
                      ? (t = t.substring(0, a + d) + v[1] + t.substring(a + d))
                      : v[0] === n &&
                        (t =
                          t.substring(0, a + d) +
                          t.substring(
                            a + this.diff_xIndex(h, p + v[1].length)
                          )),
                    v[0] !== n && (p += v[1].length);
                }
              }
        ...
        (t.prototype.patch_addPadding = function (e) {
          ...
          if (
            0 == (s = (o = e[e.length - 1]).diffs).length ||
            0 != s[s.length - 1][0]
          )
            s.push(new t.Diff(0, r)), (o.length1 += n), (o.length2 += n);
                ...
                for (
                  ...
                  1 === f
                    ...
                    ? ((c.length1 += h.length),
                      (s += h.length),
                      (l = !1),
                      c.diffs.push(new t.Diff(f, h)),
                      o.diffs.shift())
                    : ((h = h.substring(0, r - c.length1 - this.Patch_Margin)),
                      (c.length1 += h.length),
                      (s += h.length),
                      0 === f
                        ? ((c.length2 += h.length), (a += h.length))
                        : (l = !1),
                      c.diffs.push(new t.Diff(f, h)),
                      h == o.diffs[0][1]
                        ? o.diffs.shift()
                        : (o.diffs[0][1] = o.diffs[0][1].substring(h.length)));
                }
            ...
            for (
              r.push(u),
                ...
                "" === a[2]
                  ...
                  : "0" == a[2]
                  ? (u.length1 = 0)
                  : (u.start1--, (u.length1 = parseInt(a[2], 10))),
                u.start2 = parseInt(a[3], 10),
                "" === a[4]
                  ? (u.start2--, (u.length2 = 1))
                  : "0" == a[4]
                  ? (u.length2 = 0)
                  : (u.start2--, (u.length2 = parseInt(a[4], 10))),
                o++;
              o < i.length;
        ...
        var a = (function () {
          ...
          return (
            ...
            (e.prototype._getKeyIndexFromMatchingKey = function (e) {
              ...
              if (!o) return -1;
              if (n(i[0], e)) return 0;
              if (r > 1) for (var s = 1; s < o; s++) if (n(i[s], e)) return s;
              return -1;
            }),
            (e.prototype._getKeyIndexForMany = function (e) {
              ...
              if (s > 1) {
                ...
                for (a = 0; a < r; a++)
                  if ((i = n[a]).length === s && t(i[0], e[0])) return a;
              return -1;
            }),
            (e.prototype._getKeyIndexForSingle = function (e) {
              ...
              if (r > 1) {
                for (var o = 0; o < r; o++) if (!i(n[o], e[o])) return -1;
                return 0;
              }
            ...
            (e.prototype.orderByLru = function (e, t, n) {
              for (
                var r = this.keys, i = this.values, o = r.length, s = n;
                s--;
            ...
            (e.prototype.updateAsyncCache = function (e) {
              var t = this,
                ...
                o = this.keys[0],
                s = this.values[0];
              this.values[0] = s.then(
                function (n) {
                  return (
                    t.shouldUpdateOnHit && i(t, t.options, e),
                ...
                function (e) {
                  ...
                  throw (
                    (-1 !== n && (t.keys.splice(n, 1), t.values.splice(n, 1)),
                    e)
                  );
                }
              );
        ...
        function u(e, t) {
          ...
          var c = t.isEqual,
            ...
            C = function t() {
              ...
              if (-1 !== i)
                R && m(S, w, t),
                  i && (S.orderByLru(x[i], _[i], i), A && y(S, w, t));
              else {
                var o = e.apply(this, arguments),
                  s = T ? r : n(arguments);
                S.orderByLru(s, o, x.length),
                  d && S.updateAsyncCache(t),
                  E && v(S, w, t),
                  A && y(S, w, t);
              }
              return _[0];
          ...
          return (
            (C.cache = S), (C.fn = e), (C.isMemoized = !0), (C.options = w), C
          );
        }
        return u;
      })();
    ...
    7791: function (e, t, n) {
      e.exports = (function (e, t) {
        ...
        function c(e, t) {
          for (var n = 0; n < e.length; n++) if (e[n].key === t) return n;
          return -1;
        }
        function l(e, t) {
          var n =
        ...
        function p(e, t, n) {
          var r = c(e, t);
          -1 !== r && (clearTimeout(e[r].timeoutId), n && e.splice(r, 1));
        }
        function g(e, t) {
            ...
            if (-1 === c(e, f)) {
              var h = function () {
                ...
                ~i &&
                  (s.keys.splice(i, 1),
                  s.values.splice(i, 1),
                  "function" === typeof t.onCacheChange &&
                    t.onCacheChange(s, a, u)),
                  p(e, f, !0),
                  "function" === typeof t.onExpire &&
                    !1 === t.onExpire(f) &&
                    (s.keys.unshift(f),
                    s.values.unshift(c),
                    o(s, a, u),
              ...
              e.push({ expirationMethod: h, key: f, timeoutId: g(h, i) });
            }
          };
        }
        function y(e, t) {
          return function (n) {
            ...
            ~i &&
              (p(e, r, !1),
              (e[i].timeoutId = g(e[i].expirationMethod, t.maxAge)));
          };
        }
        function m(e, t, n, r) {
          var i =
            "number" === typeof t.maxAge && isFinite(t.maxAge)
              ? v(e, t, n, r)
              : void 0;
          return {
            onCacheAdd: i,
        ...
        function _(e) {
          var t = e.profileName;
          return function () {
            t && !b.profiles[t] && (b.profiles[t] = { calls: 0, hits: 0 }),
              b.profiles[t].calls++;
          };
        }
        function k(e) {
          return function () {
            var t = b.profiles,
              n = e.profileName;
            t[n] || (t[n] = { calls: 0, hits: 0 }), t[n].calls++, t[n].hits++;
          };
        }
        function T(e) {
          return (
            e.displayName ||
            e.name ||
            "Anonymous " + b.anonymousProfileNameCounter++
          );
        }
        function E(e, t) {
          return e ? ((t / e) * 100).toFixed(4) + "%" : "0.0000%";
        }
        function A(e) {
          b.isCollectingStats ||
            w ||
          ...
          var t = b.profiles;
          if (e) {
            if (!t[e]) return { calls: 0, hits: 0, usage: "0.0000%" };
            var n = t[e];
            return i({}, n, { usage: E(n.calls, n.hits) });
          }
          var r = Object.keys(b.profiles).reduce(
            function (e, n) {
          ...
          return i({}, r, {
            profiles: Object.keys(t).reduce(function (e, t) {
              return (e[t] = A(t)), e;
            }, {}),
        ...
        function O(e, t) {
          ...
          (o.clear = function () {
            ...
            (o.set = function (e, t) {
              ...
              if (-1 === f) {
                var h = s.maxSize - 1;
                r.size > h && ((r.keys.length = h), (r.values.length = h)),
                  r.keys.unshift(l),
                  r.values.unshift(t),
                  s.isPromise && r.updateAsyncCache(o),
                  a && a(r, s, o),
                  u && u(r, s, o);
              } else {
                var d = r.keys[f];
                (r.values[f] = t),
                  f > 0 && r.orderByLru(d, t, f),
                  s.isPromise && r.updateAsyncCache(o),
                  "function" === typeof u && u(r, s, o);
              }
            }),
            (o.values = function () {
        ...
        var M =
          "function" === typeof Symbol && Symbol.for
            ...
            : 60103;
        function V(e, t, n) {
          var r = e(i({ maxArgs: 2, isShallowEqual: !0 }, n, { isReact: !1 }));
          function o(e, n, i) {
            (this.props = e),
              (this.context = n),
              (this.updater = i),
              (this.MoizedComponent = r(t));
          }
          return (
            t.displayName || (t.displayName = t.name || "Component"),
            ...
            I(t, o, ["contextType", "contextTypes"]),
            (o.displayName =
              "Moized(" + (t.displayName || t.name || "Component") + ")"),
            d(o, t.name, n.profileName),
            o
          );
        }
        function B(e) {
        ...
        function L() {
          ...
          return function (n, r) {
            ...
            if ("object" === typeof r) {
              if (e.length) {
                var o = P(e, this);
                0 === o ? (e[e.length] = this) : (e.splice(o), t.splice(o)),
                  (t[t.length] = n);
                var s = P(e, r);
                if (0 !== s)
                  return "[ref=" + (t.slice(0, s).join(".") || ".") + "]";
              } else (e[0] = r), (t[0] = n);
              return r;
            }
            return "" + r;
        ...
        function q(e) {
          return (
            e.matchesArg ||
            (e.isDeepEqual && t.deepEqual) ||
            (e.isShallowEqual && t.shallowEqual) ||
        ...
        function $(e) {
          return u(
            e.isSerialized && F(e),
            "function" === typeof e.transformArgs && e.transformArgs,
            "number" === typeof e.maxArgs && B(e.maxArgs)
          );
        }
        function H(e) {
        ...
        var W = [
          ...
          G = function e(t, n) {
            ...
            var p = i({}, s, u, {
                maxAge:
                  "number" === typeof u.maxAge && u.maxAge >= 0
                    ? u.maxAge
                    : s.maxAge,
                maxArgs:
                  "number" === typeof u.maxArgs && u.maxArgs >= 0
                    ? u.maxArgs
                    : s.maxArgs,
                maxSize:
                  "number" === typeof u.maxSize && u.maxSize >= 0
                    ? u.maxSize
                    : s.maxSize,
        ...
        function Y(e, t) {
          if (!0 === t) return G({ maxAge: e, updateExpire: t });
          if ("object" === typeof t) {
            var n = t.onExpire,
              r = t.updateExpire;
            return G({ maxAge: e, onExpire: n, updateExpire: r });
          }
          return G(
            "function" === typeof t
              ? { maxAge: e, onExpire: t, updateExpire: !0 }
              : { maxAge: e }
          );
        }
        return (
          ...
          (G.deep = G({ isDeepEqual: !0 })),
          (G.getStats = A),
          (G.infinite = G({ maxSize: 1 / 0 })),
          ...
          (G.matchesArg = function (e) {
            return G({ matchesArg: e });
          }),
          (G.matchesKey = function (e) {
            return G({ matchesKey: e });
          }),
          (G.maxAge = Y),
          (G.maxArgs = function (e) {
            return G({ maxArgs: e });
          }),
          ...
          (G.profile = function (e) {
            return G({ profileName: e });
          }),
          (G.promise = G({ isPromise: !0, updateExpire: !0 })),
          (G.react = G({ isReact: !0 })),
          (G.serialize = G({ isSerialized: !0 })),
          (G.serializeWith = function (e) {
            return G({ isSerialized: !0, serializer: e });
          }),
          (G.shallow = G({ isShallowEqual: !0 })),
          (G.transformArgs = function (e) {
            return G({ transformArgs: e });
          }),
          (G.updateCacheForKey = function (e) {
            return G({ updateCacheForKey: e });
          }),
    ...
    3947: function (e, t) {
      "use strict";
      t.Z = {
        src: "static/_next/static/media/book-open.e6d9fcb0.svg",
        height: 17,
        width: 20,
      };
    },
    9454: function (e, t) {
      "use strict";
      t.Z = {
        src: "static/_next/static/media/speech-bubble.342ebbc8.svg",
        height: 18,
        width: 18,
      };
    },
    6787: function (e, t) {
      "use strict";
      t.Z = {
        src: "static/_next/static/media/walking.a0f1929a.svg",
        height: 21,
        width: 15,
      };
    },
    8401: function (e, t, n) {
      ...
      !(function (e) {
        ...
        (function (e) {
          (e.TrimTop = "trimTop"),
            (e.TrimBottom = "trimBottom"),
            (e.DoNotTrim = "doNotTrim");
        })(i || (i = {}));
      var u = (function () {
        function e() {
          (0, o.Z)(this, e),
            ...
            (this.budgetPriority = 400),
            (this.trimDirection = i.TrimBottom),
            (this.insertionType = r.NewLine),
            (this.maximumTrimType = r.Sentence),
      ...
      (0, s.yu)(c, { text: (0, s.Ru)(), contextConfig: (0, s.Ry)(u) });
      var l = function () {
          var e = new u();
          return (
            (e.prefix = ""),
            (e.suffix = ""),
            (e.tokenBudget = a.Lb),
            (e.reservedTokens = 512),
            (e.budgetPriority = 0),
            (e.trimDirection = i.TrimTop),
            (e.insertionType = r.NewLine),
            (e.maximumTrimType = r.Sentence),
            (e.insertionPosition = -1),
            (e.allowInsertionInside = !0),
            e
          );
        },
        f = function () {
          ...
          return (
            ...
            (e.tokenBudget = a.Lb),
            (e.reservedTokens = 0),
            (e.budgetPriority = 800),
            (e.trimDirection = i.TrimBottom),
            (e.insertionType = r.NewLine),
            (e.maximumTrimType = r.Sentence),
            (e.insertionPosition = 0),
            e
          );
        },
        h = function () {
          ...
          return (
            ...
            (e.suffix = "\n"),
            (e.tokenBudget = a.Lb),
            (e.reservedTokens = a.Lb),
            (e.budgetPriority = -400),
            (e.trimDirection = i.TrimBottom),
            (e.insertionType = r.NewLine),
            (e.maximumTrimType = r.Sentence),
            (e.insertionPosition = -4),
            e
          );
        },
        d = function () {
        ...
        p = function () {
          ...
          return (
            ...
            (e.tokenBudget = a.Lb),
            (e.reservedTokens = a.Lb),
            (e.budgetPriority = -1e4),
            (e.trimDirection = i.DoNotTrim),
            (e.insertionType = r.NewLine),
            (e.maximumTrimType = r.NewLine),
            (e.insertionPosition = -2),
            e
          );
        };
    },
      ...
      var r = n(9951),
        ...
        a = (function (e) {
          ...
          function n() {
            ...
            return (
              (0, r.Z)(this, n),
              ((e = t.apply(this, arguments)).startingStep = 1),
              (e.delay = 0),
              (e.duration = 1),
              (e.repeat = !1),
              (e.reverse = !1),
    ...
    8346: function (e, t, n) {
      ...
      var r = n(9951),
        ...
        d = (function (e) {
          ...
          function n() {
            ...
            return (
              (0, r.Z)(this, n),
              ((e = t.call(this, i, s)).lastUpdatedAt = new Date()),
              (e.displayName = "New Lorebook Entry"),
              (e.id = (0, u.Z)()),
              (e.keys = []),
              (e.searchRange = 1e3),
              (e.enabled = !0),
              (e.forceActivation = !1),
              (e.keyRelative = !1),
              (e.nonStoryActivatable = !1),
              (e.category = ""),
              (e.loreBiasGroups = [new f.VK()]),
              (e.displayName = a),
              (e.keys = (0, o.Z)(c)),
              e
            );
      ...
      var p = new Set(["s", "i", "u", "m"]),
        g = l()({ maxSize: 50 })(function (e) {
          ...
          return { isRegex: t, regex: i, flags: r, placeholders: "$" === n };
        });
      l()({ maxSize: 50 })(function (e) {
        try {
          var t = g(e);
      ...
      var r = n(6404),
        ...
        g = (function () {
          ...
          return (
            ...
            (t.getKey = function (e) {
              return new Uint8Array(f.Buffer.from(this.keys[e])).buffer;
            }),
                      ...
                      switch ((n.prev = n.next)) {
                        ...
                        case 4:
                          return (
                            (o = n.sent),
                            (n.next = 7),
                            crypto.subtle.importKey("raw", o, i, !1, [
                              "encrypt",
                              "decrypt",
                            ])
                          );
                    ...
                    for (;;)
                      switch ((r.prev = r.next)) {
                        case 0:
                          ...
                          throw new Error(
                            "Couldn't parse the response from the server"
                          );
                        case 2:
                          return (
                            (i = new Uint8Array(f.Buffer.from(e.iv))),
                            (o = { name: "AES-CBC", iv: i }),
                            (r.next = 6),
                            crypto.subtle.digest(
                              "SHA-256",
                        ...
                        case 6:
                          return (
                            (s = r.sent),
                            (r.next = 9),
                            crypto.subtle.importKey("raw", s, o, !1, [
                              "encrypt",
                              "decrypt",
                            ])
                          );
                        case 9:
                          return (
                            (a = r.sent),
                            (r.next = 12),
                            crypto.subtle.decrypt(o, a, f.Buffer.from(e.data))
                          );
                        case 12:
                          return (
                            (u = r.sent),
                    ...
                    for (;;)
                      switch ((n.prev = n.next)) {
                        case 0:
                          ...
                          throw new Error(
                            "Can't change key of unloaded keystore"
                          );
                        case 2:
                          return (
                            (n.next = 4),
                        ...
                        case 4:
                          return (
                            (r = n.sent),
                            (n.next = 7),
                            crypto.subtle.importKey("raw", r, t.param, !1, [
                              "encrypt",
                              "decrypt",
                            ])
                          );
                      ...
                      switch ((r.prev = r.next)) {
                        ...
                        case 3:
                          ...
                          return (
                            ...
                            (r.next = 7),
                            crypto.subtle.digest("SHA-256", o)
                          );
                        case 7:
                          (i = r.sent),
                            n.data.setKey(e.id, i),
                            t(),
                            (r.next = 13);
                          break;
                        case 12:
                        ...
                        case 13:
                          return (
                            (r.next = 15),
                            crypto.subtle.importKey("raw", i, n.param, !1, [
                              "encrypt",
                              "decrypt",
                            ])
                          );
                        ...
                        case 19:
                          return (
                            ...
                            (c = {
                              id: e.id,
                              data: f.Buffer.from(u).toString("base64"),
                      ...
                      switch ((i.prev = i.next)) {
                        ...
                        case 3:
                          ...
                          return (
                            ...
                            (i.next = 7),
                            crypto.subtle.digest("SHA-256", s)
                          );
                        case 7:
                          (o = i.sent),
                            r.data.setKey(t.id, o),
                            n(),
                            (i.next = 13);
                          break;
                        case 12:
                        ...
                        case 13:
                          return (
                            (i.next = 15),
                            crypto.subtle.importKey("raw", o, r.param, !1, [
                              "encrypt",
                              "decrypt",
                            ])
                          );
                        ...
                        case 19:
                          return (
                            ...
                            (h = {
                              id: t.id,
                              data: f.Buffer.from(c).toString("base64"),
                    ...
                    for (;;)
                      switch ((n.prev = n.next)) {
                        ...
                        case 2:
                          ...
                          return (
                            (0, h.KE)(e.meta, !1, "No key for dto"),
                            n.abrupt("return", null)
                          );
                        case 5:
                          return (
                            (r = t.data.getKey(e.meta)),
                            (n.next = 8),
                            crypto.subtle.importKey("raw", r, t.param, !1, [
                              "encrypt",
                              "decrypt",
                        ...
                        case 8:
                          return (
                            (i = n.sent),
                            (o = new Uint8Array(f.Buffer.from(e.data, "base64"))
                              .buffer),
                            (n.next = 12),
                            crypto.subtle.decrypt(t.param, i, o)
                          );
                        case 12:
                          return (
                            (s = n.sent),
                            (a = new TextDecoder().decode(s)),
                            (u = p.LP.deserialize(a)),
                            n.abrupt("return", u)
                          );
                        case 16:
                        case "end":
                      ...
                      function (i) {
                        for (;;)
                          switch ((i.prev = i.next)) {
                            case 0:
                              if (
                                ((o = f.Buffer.from(e, "base64")),
                                (s = JSON.parse(o.toString("utf8"))))
                              ) {
                                i.next = 4;
                                break;
                              }
                            ...
                            case 23:
                              (i.prev = 23),
                                ...
                                (0, h.H)(
                                  i.t1,
                                  !1,
                                  "There is some trouble unlocking the legacy keystore"
                                );
                            case 26:
                              return (
                                (i.next = 28),
                        ...
                        switch ((t.prev = t.next)) {
                          ...
                          case 2:
                            return (
                              (n = t.sent),
                              e.legacyPayload &&
                                ((n.iv = e.legacyPayload.iv),
                                (n.data = e.legacyPayload.data)),
                              t.abrupt(
                                "return",
                                f.Buffer.from(JSON.stringify(n)).toString(
                                  "base64"
                                )
                              )
                            );
                      ...
                      for (;;)
                        switch ((r.prev = r.next)) {
                          case 0:
                            return r.abrupt(
                              "return",
                              n.keystore.encryptStoryMetadata(e, t)
                            );
                          case 1:
                          case "end":
                            return r.stop();
                      ...
                      for (;;)
                        switch ((i.prev = i.next)) {
                          case 0:
                            return i.abrupt(
                              "return",
                              r.keystore.encryptStoryContent(e, t, n)
                            );
                          case 1:
                          case "end":
                            return i.stop();
                          ...
                          switch ((n.prev = n.next)) {
                            case 0:
                              return (
                                (n.prev = 0),
                                (n.next = 3),
                                t.keystore.decryptStoryContent(e)
                              );
                            case 3:
                            case 12:
                            ...
                            case 6:
                              if (
                                ((n.prev = 6), (n.t0 = n.catch(0)), !t.legacy)
                              ) {
                                n.next = 20;
                                break;
                              }
                              return (
                                (n.prev = 9),
                                (n.next = 12),
                                t.legacy.decryptStoryContent(e)
                              );
                            case 15:
                          ...
                          switch ((n.prev = n.next)) {
                            case 0:
                              return (
                                (n.prev = 0),
                                (n.next = 3),
                                t.keystore.decryptStoryMetadata(e)
                              );
                            case 3:
                            case 12:
                              return n.abrupt("return", n.sent);
                            case 6:
                              ...
                              return (
                                (n.prev = 9),
                                (n.next = 12),
                                t.legacy.decryptStoryMetadata(e)
                              );
                            case 15:
                              throw ((n.prev = 15), (n.t1 = n.catch(9)), n.t0);
                            case 18:
    ...
    7607: function (e, t, n) {
      ...
      n(1854);
      !(function (e) {
        (e[(e.RawString = 0)] = "RawString"),
          (e[(e.GPT2Tokens = 1)] = "GPT2Tokens"),
          (e[(e.InterpretedString = 2)] = "InterpretedString"),
          (e[(e.PileNaiTokens = 3)] = "PileNaiTokens"),
          (e[(e.GenjiTokens = 4)] = "GenjiTokens"),
          (e[(e.NAIInlineTokens = 5)] = "NAIInlineTokens");
      })(r || (r = {}));
      ...
      var a = function e() {
        ...
        (0, i.Z)(this, e),
          (this.phrases = []),
          (this.bias = 0),
          (this.ensure_sequence_finish = void 0),
          (this.ensureSequenceFinish = !1),
          (this.generate_once = void 0),
          (this.generateOnce = !0),
          (this.enabled = !0),
          (this.whenInactive = !1),
          (this.phrases = t),
    ...
    9268: function (e, t, n) {
      ...
      (0, i.yu)(f, { orderByKeyLocations: (0, i.Ru)() });
      var h = function e() {
        (0, r.Z)(this, e),
          (this.name = "New Category"),
          (this.id = (0, o.Z)()),
          (this.enabled = !0),
          (this.createSubcontext = !1),
          (this.subcontextSettings = new u.SI((0, u.xk)())),
          (this.useCategoryDefaults = !1),
          (this.categoryDefaults = new c.Up()),
          (this.categoryBiasGroups = [new l.VK()]);
      };
      (0, i.yu)(h, {
        name: (0, i.Ru)(),
        id: (0, i.Ru)(),
    ...
    8906: function (e, t, n) {
      ...
      var p = function e() {
          (0, s.Z)(this, e),
            (this.dataBlocks = 0),
            (this.abandonedDataBlocks = 0),
            (this.chainedBlocks = 0),
            (this.editBlocks = 0),
            (this.chainedEditBlocks = 0),
            (this.responseBlocks = 0),
            (this.chainedResponseBlocks = 0),
            (this.userBlocks = 0),
            (this.chainedUserBlocks = 0),
            (this.currentStep = 0),
            (this.furthestStep = 0),
            (this.characters = 0),
            (this.abandonedCharacters = 0),
            (this.paragraphs = 0),
            (this.deadEnds = 0),
            (this.noRetryStreak = 0),
            (this.longestAbandonedBranch = 0),
            (this.retries = 0),
            (this.stepsWhereResponseWasRequested = 0),
            (this.inputCharacters = 0),
            (this.abandonedInputCharacters = 0),
            (this.responseCharacters = 0),
            (this.abandonedResponseCharacters = 0),
            (this.editCharacters = 0),
            (this.abandonedEditCharacters = 0),
      ...
      (0, f.yu)(v, { data: (0, f.Ru)(), origin: (0, f.Ru)() });
      var y = function e(t) {
        var n =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "",
          r =
      ...
      var m = (function () {
        function e() {
          (0, s.Z)(this, e),
            ...
            (this.version = 2),
            (this.currentBlock = 0),
            this.datablocks.push(new y(r.root)),
            this.fragments.push(new v("", r.root));
        }
        var t = e.prototype;
        return (
          (t.append = function (e, t) {
            this.insert(e, t, this.getText().length, this.getText().length);
          }),
          (t.insert = function (e, t, n, r) {
            ...
            (o.prevBlock = this.currentBlock),
              (this.datablocks[this.currentBlock].nextBlock[
                this.datablocks[this.currentBlock].nextBlock.length
              ] = s),
              this.datablocks.push(o),
              this.updateStory(s);
          }),
          (t.undo = function () {
            if (this.canUndo()) {
              var e =
                this.datablocks[this.datablocks[this.currentBlock].prevBlock]
                  .chain;
          ...
          (t.redo = function () {
            ...
            return (
              !!this.datablocks[this.currentBlock].nextBlock[e] &&
              (this.updateStory(
                this.datablocks[this.currentBlock].nextBlock[e]
              ),
              this.datablocks[this.currentBlock].chain && this.redo(),
              !0)
            );
          }),
          (t.edit = function (e, t) {
            var n,
              i = new h.diff_match_patch(),
            ...
            try {
              for (
                ...
                var g = d.value;
                if (-1 === g[0]) n = { diff: g, start: u };
                else if (1 === g[0]) {
                  var v = n ? u + n.diff[1].length : u;
                  s.push({ text: g[1], startIndex: u, endIndex: v }),
                    (n = void 0);
                } else
                  n &&
                    s.push({
            ...
            try {
              for (
                var w, S = s.entries()[Symbol.iterator]();
                !(y = (w = S.next()).done);
                y = !0
              ) {
                var x = (0, a.Z)(w.value, 2),
                  _ = x[0],
                  k = x[1];
                0 === this.getText().length
                  ? this.append(
                      null !== t && void 0 !== t ? t : r.prompt,
                      k.text
                    )
                  : k.startIndex === this.getText().length
                  ? this.append(null !== t && void 0 !== t ? t : r.user, k.text)
                  : this.insert(
                      null !== t && void 0 !== t ? t : r.edit,
                      k.text,
                      k.startIndex,
                      k.endIndex,
                      _ !== s.length - 1
          ...
          (t.getRedoOptions = function () {
            for (
              var e = [], t = this.datablocks[this.currentBlock], n = 0;
              n < t.nextBlock.length;
              n++
            ) {
              ...
              do {
                i[0].push(
                  this.getRemovedFragments(this.getFragmentChangeIndices(r))
                    .map(function (e) {
                      return e.data;
                    })
                    .join("")
                ),
                  i[1].push(r.dataFragment.data),
                  (o = r.chain),
                  (r = this.datablocks[r.nextBlock[r.redoPath]]);
              } while (r && o);
              e.push(i);
            }
            return e;
          ...
          (t.lastInsertionInfo = function () {
            ...
            if (
              ...
              void 0 === (t = this.datablocks[t.prevBlock]))
            )
              return e;
            for (; t.chain; )
              e.push({
          ...
          (t.reconstructStory = function () {
            for (var e = this.currentBlock; 0 !== this.currentBlock; )
              this.undo();
            var t = !0,
              n = !1,
              r = void 0;
            try {
              for (
                var i, o = this.datablocks[Symbol.iterator]();
                !(t = (i = o.next()).done);
                t = !0
              ) {
            ...
            for (
              this.step = 0;
              this.currentBlock !== e && this.datablocks[this.currentBlock];
          ...
          (t.resetToPrompt = function () {
            ...
            for (var n = 0, i = this.fragments.length - 1; i > 0; --i)
              if (
                this.fragments[i].origin === r.prompt ||
                this.fragments[i].origin === r.flattened
              ) {
                n = i;
                break;
              }
          ...
          (t.trimBeforeStep = function (t) {
            ...
            for (
              var n = this.datablocks[this.currentBlock], i = n, o = this.step;
              -1 != n.prevBlock && o >= t;

            )
              (i = n),
                n.origin !== r.edit && o--,
                (n = this.datablocks[n.prevBlock]);
            var s = this.datablocks.indexOf(i),
              a = e.performBranchTrim(this.datablocks, s),
              c =
                a.length -
                (this.datablocks.length - this.datablocks.indexOf(i)),
            ...
            try {
              for (
                var p, g = l[Symbol.iterator]();
                !(f = (p = g.next()).done);
                f = !0
              ) {
                var v = p.value;
                v.prevBlock -= c;
                for (var y = 0; y < v.nextBlock.length; y++)
                  v.nextBlock[y] -= c;
              }
            } catch (m) {
              (h = !0), (d = m);
            ...
            (this.datablocks = (0, u.Z)(a).concat((0, u.Z)(l))),
              (this.currentBlock = this.datablocks.length - 1);
          }),
          (t.updateStory = function (e) {
            (this.currentBlock = e),
              this.datablocks[e].startIndex === this.getText().length &&
              "edit" !== this.datablocks[e].origin
                ? this.appendFragment(this.datablocks[e].dataFragment)
                : this.insertFragment(this.datablocks[e]),
              "edit" !== this.datablocks[e].origin && this.step++,
              this.generateText();
          }),
          (t.rollbackStory = function () {
            ...
            if (1 === t.length)
              n.push(
                new v(
                  this.fragments[e.fragmentIndex - 1].data +
                    t[0].data +
                    this.fragments[e.fragmentIndex + 1].data,
                  t[0].origin
                )
              ...
              if (
                (n.push(
                  new v(
                    this.fragments[e.fragmentIndex - 1].data + t[0].data,
                    this.fragments[e.fragmentIndex - 1].origin
                  )
                ),
                t.length > 2)
              )
                (r = n).push.apply(r, (0, u.Z)(t.slice(1, -1)));
              n.push(
                new v(
                  t[t.length - 1].data +
                    this.fragments[e.fragmentIndex + 1].data,
            ...
            this.fragments =
              this.datablocks[this.currentBlock].fragmentIndex ===
              this.fragments.length - 1
                ? this.fragments.slice(0, -1)
                : (0, u.Z)(
                    this.fragments.slice(
                      0,
                      this.datablocks[this.currentBlock].fragmentIndex - 1
                    )
                  ).concat(
                    (0, u.Z)(n),
                    (0, u.Z)(
                      this.fragments.slice(
                        this.datablocks[this.currentBlock].fragmentIndex + 2
                      )
                    )
                  );
            ...
            (this.datablocks[this.currentBlock].removedFragments = []),
              (this.currentBlock =
                this.datablocks[this.currentBlock].prevBlock),
              (this.datablocks[this.currentBlock].redoPath =
                this.datablocks[this.currentBlock].nextBlock.indexOf(i)),
              "edit" !== this.datablocks[i].origin && this.step--,
              this.generateText();
          }),
          (t.appendFragment = function (e) {
            (this.datablocks[this.currentBlock].fragmentIndex =
              this.fragments.length),
              (this.fragments = (0, u.Z)(this.fragments).concat([e]));
          }),
          (t.insertFragment = function (e) {
            var t = this.getFragmentChangeIndices(e),
              n = new v(
                this.fragments[t.lowerFragmentIndex].data.slice(
                  0,
                  this.fragments[t.lowerFragmentIndex].data.length -
                    t.removedLowerCharacters
                ),
                this.fragments[t.lowerFragmentIndex].origin
              ),
              r = new v(
                this.fragments[t.upperFragmentIndex].data.slice(
                  this.fragments[t.upperFragmentIndex].data.length -
                    t.remainingUpperCharacters
                ),
                this.fragments[t.upperFragmentIndex].origin
              );
            (e.removedFragments = this.getRemovedFragments(t)),
              (e.fragmentIndex = t.lowerFragmentIndex + 1),
              (this.fragments = (0, u.Z)(
                this.fragments.slice(0, t.lowerFragmentIndex)
              ).concat(
                [n, e.dataFragment, r],
                (0, u.Z)(this.fragments.slice(t.upperFragmentIndex + 1))
              ));
          }),
          (t.getFragmentChangeIndices = function (e) {
            for (
              var t = this.getText().length,
                n = !1,
                r = this.fragments.length - 1;
              !n && r >= 0;

            )
              e.endIndex >= t - this.fragments[r].data.length
                ? (n = !0)
                : ((t -= this.fragments[r].data.length), r--);
            for (var i = r, o = t - e.endIndex, s = !1; !s && r >= 0; )
              e.startIndex >= t - this.fragments[r].data.length
                ? (s = !0)
                : ((t -= this.fragments[r].data.length), r--);
            return {
          ...
          (t.getRemovedFragments = function (e) {
            var t,
              n = [];
            e.lowerFragmentIndex === e.upperFragmentIndex
              ? n.push(
                  new v(
                    this.fragments[e.lowerFragmentIndex].data.slice(
                      this.fragments[e.lowerFragmentIndex].data.length -
                        e.removedLowerCharacters,
                      this.fragments[e.lowerFragmentIndex].data.length -
                        e.remainingUpperCharacters
                    ),
                    this.fragments[e.lowerFragmentIndex].origin
                  )
                )
              : (t = n).push.apply(
                  t,
                  [
                    ...
                    (0, u.Z)(
                      this.fragments.slice(
                        e.lowerFragmentIndex + 1,
                        e.upperFragmentIndex
                      )
                    ),
                    [
                      new v(
                        this.fragments[e.upperFragmentIndex].data.slice(
                          0,
                          this.fragments[e.upperFragmentIndex].data.length -
                            e.remainingUpperCharacters
                        ),
                        this.fragments[e.upperFragmentIndex].origin
                      ),
                    ]
                  )
                );
          ...
          (t.getText = function () {
            var e;
            return (
              void 0 === this.text && this.generateText(),
              null !== (e = this.text) && void 0 !== e ? e : ""
            );
          }),
                      ...
                      switch ((t.prev = t.next)) {
                        case 0:
                          (n = function () {
                            ...
                            if (!b) {
                              "edit" !== t.origin && y.currentStep++,
                                y.currentStep > i.furthestStep &&
                                  (i.furthestStep = y.currentStep);
                              var n = 0,
                                o = !0,
                                s = !1,
                                a = void 0;
                              try {
                                for (
                                  var u, c = t.nextBlock[Symbol.iterator]();
                                  !(o = (u = c.next()).done);
                                  o = !0
                                ) {
                                  var l = u.value;
                              ...
                              if (
                                (n > 0 && i.stepsWhereResponseWasRequested++,
                                n > 1 &&
                                  ((i.retries += n - 1),
                                  n - 1 > i.mostRetries &&
                                    (i.mostRetries = n - 1)),
                                n < 2 && !t.chain && t.origin !== r.edit
                                  ? (y.noRetryStreak++,
                                    y.noRetryStreak > i.noRetryStreak &&
                                      (i.noRetryStreak = y.noRetryStreak))
                                  : n > 1 && (y.noRetryStreak = 0),
                                h.has(w))
                              )
                                switch (t.origin) {
                                  case r.ai:
                                    i.responseCharacters +=
                                      t.dataFragment.data.length;
                                    break;
                                  case r.user:
                                    i.inputCharacters +=
                                      t.dataFragment.data.length;
                                  ...
                                  case r.edit:
                                    (i.editCharacters +=
                                      t.dataFragment.data.length),
                                      (i.deletedCharacters += t.removedFragments
                                        .map(function (e) {
                                          return e.data;
                                        })
                                        .join("").length);
                                ...
                                switch (
                                  ((i.abandonedCharacters +=
                                    t.dataFragment.data.length),
                                  t.origin)
                                ) {
                                  case r.ai:
                                    i.abandonedResponseCharacters +=
                                      t.dataFragment.data.length;
                                    break;
                                  case r.user:
                                    i.abandonedInputCharacters +=
                                      t.dataFragment.data.length;
                                    break;
                                  case r.edit:
                                    i.abandonedEditCharacters +=
                                      t.dataFragment.data.length;
                                }
                                i.abandonedDataBlocks++,
                                  0 === t.nextBlock.length && i.deadEnds++,
                                  y.longestAbandonedBranch++,
                                  !t.chain &&
                                    y.longestAbandonedBranch >
                                      i.longestAbandonedBranch &&
                                    (i.longestAbandonedBranch =
                                      y.longestAbandonedBranch);
                              }
                            }
                            ...
                            try {
                              for (
                                var x, _ = t.nextBlock[Symbol.iterator]();
                                !(d = (x = _.next()).done);
                                d = !0
                              ) {
                                var k = x.value;
                                if (!g.has(k)) {
                                  v.push(w),
                                    m.push(JSON.parse(JSON.stringify(y))),
                                    (w = k),
                                    (f = !0);
                                  break;
                                }
                            ...
                            (a = void 0),
                            (t.prev = 3),
                            (u = e.datablocks[Symbol.iterator]());
                        case 5:
                          if ((o = (c = u.next()).done)) {
                            t.next = 35;
                            break;
                        ...
                        case 12:
                          return (
                            i.chainedResponseBlocks++, t.abrupt("break", 19)
                          );
                        case 14:
                        ...
                        case 48:
                          return t.finish(41);
                        case 49:
                          for (h = new Set(), d = e.currentBlock; d >= 0; )
                            h.add(d), (d = e.datablocks[d].prevBlock);
                          (g = new Set()),
                            (v = []),
                            (y = {
                              currentStep: -1,
                        ...
                        case 64:
                          return (
                            (i.currentStep = e.step),
                            (i.characters = e.getText().length),
                            (i.paragraphs =
                              e.getText().split(/^.+$/m).length - 1),
                            t.abrupt("return", i)
                          );
                        case 68:
                        case "end":
          ...
          (e.performBranchTrim = function (e, t) {
            for (var n = e[t], r = []; -1 != n.prevBlock; )
              r.push((0, d.v)(y, (0, f.qC)(n))), (n = e[n.prevBlock]);
            r.push(n);
            for (var i = [], o = 0, s = r.length - 1; s >= 0; s--) {
              var a = r[s];
              s !== r.length - 1 && (a.prevBlock = o - 1),
                0 !== s && (a.nextBlock = [o + 1]),
                (a.redoPath = 0),
                i.push(a),
                o++;
    ...
    6411: function (e, t, n) {
      ...
      var r = n(9951),
        ...
        S = (function () {
          function e() {
            (0, r.Z)(this, e),
              (this.ephemeralDefaults = [new u.ct((0, a.$M)())]),
              (this.loreDefaults = [new c.Up((0, a.xk)())]);
          }
          return (
            (e.prototype.serialize = function () {
              var t =
      ...
      var x = (function () {
        function e() {
          (0, r.Z)(this, e),
            (this.storyContentVersion = 5),
            (this.settings = new p.ax()),
            (this.story = void 0),
            (this.document = void 0),
            (this.context = []),
            (this.lorebook = new v.H2()),
            (this.storyContextConfig = (0, a.i_)()),
            (this.ephemeralContext = []),
            (this.contextDefaults = new S()),
            (this.settingsDirty = !1),
            (this.changeIndex = 1),
            (this.phraseBiasGroups = [new y.VK()]),
            (this.bannedSequenceGroups = [new m.M()]),
            this.context.push(new a.SI((0, a.WR)()), new a.SI((0, a.oX)()));
        }
        var t = e.prototype;
        return (
          (t.getStoryText = function () {
          ...
          (t.serialize = function () {
            var t =
              arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
            return (
              (0, d.o7)("serializing StoryContent", this),
              JSON.stringify((0, i.qC)(e, this), void 0, t ? "  " : void 0)
            );
          }),
          (e.deserialize = function (t) {
            var n, r;
            ...
            var i = JSON.parse(t),
              o = (0, h.v)(e, i);
            return (
              (o.settings.parameters.textGenerationSettingsVersion =
                null === (n = i.settings) ||
                void 0 === n ||
                null === (r = n.parameters) ||
                void 0 === r
                  ? void 0
                  : r.textGenerationSettingsVersion),
              (0, f.Pm)(o),
              o
            );
          }),
      ...
      (0, i.yu)(_, { type: (0, i.Ru)(), id: (0, i.Ru)() });
      var k = (function () {
        function e() {
          (0, r.Z)(this, e),
            (this.storyMetadataVersion = 1),
            (this.id = (0, o.Z)()),
            (this.remote = !1),
        ...
        return (
          (t.save = function () {
            var e =
              ...
              arguments[0];
            return (
              (this.isModified = e || this.isModified),
              (this.lastUpdatedAt = new Date()),
              new l.sK(this.id, 1)
            );
          }),
      ...
      var T = (function () {
        ...
        return (
          ...
          (e.deserialize = function (t) {
            ...
            return (
              (s.content.settings.parameters.textGenerationSettingsVersion =
                null === (n = o.content) ||
                void 0 === n ||
                null === (r = n.settings) ||
                void 0 === r ||
                ...
                void 0 === i
                  ? void 0
                  : i.textGenerationSettingsVersion),
              (0, f.Fc)(s),
              s
            );
          }),
          (e.bundle = function (t, n) {
            var r = new e();
            return (
              (r.metadata = null !== t && void 0 !== t ? t : r.metadata),
              (r.content = null !== n && void 0 !== n ? n : r.content),
              r
            );
          }),
          e
    ...
    5892: function (e, t, n) {
      ...
      !(function (e) {
        (e.Temperature = "temperature"),
          ...
          (e.TFS = "tfs"),
          (e.TopA = "top_a"),
          (e.TypicalP = "typical_p");
      })(r || (r = {}));
      var m = function e(t, n) {
        (0, o.Z)(this, e), (this.id = t), (this.enabled = n);
      };
      (0, u.yu)(m, { id: (0, u.Ru)(), enabled: (0, u.Ru)() });
      var b = (function () {
        function e() {
          (0, o.Z)(this, e),
            (this.textGenerationSettingsVersion = 3),
            ...
            (this.top_a = 1),
            (this.typical_p = 1),
            (this.tail_free_sampling = 1),
            (this.repetition_penalty = 2.75),
            (this.repetition_penalty_range = 2048),
            (this.repetition_penalty_slope = 0.18),
            (this.eos_token_id = void 0),
            (this.bad_words_ids = void 0),
            (this.logit_bias_groups = void 0),
            (this.repetition_penalty_frequency = 0),
            (this.repetition_penalty_presence = 0),
            (this.order = [
              { id: r.Temperature, enabled: !0 },
              { id: r.TopK, enabled: !0 },
              { id: r.TopP, enabled: !0 },
              { id: r.TFS, enabled: !0 },
              { id: r.TopA, enabled: !1 },
              { id: r.TypicalP, enabled: !1 },
            ]);
        }
        return (
          (e.prototype.serialize = function () {
          ...
          (e.deserialize = function (t) {
            ...
            return (
              (r.textGenerationSettingsVersion =
                n.textGenerationSettingsVersion),
              (0, d.YE)(r),
              r
            );
          }),
      ...
      var w = function e() {
        (0, o.Z)(this, e),
          ...
          (this.ephemeralDefaults = [new f.ct((0, l.$M)())]),
          (this.loreDefaults = [new h.Up((0, l.xk)())]),
          (this.storyDefault = (0, l.i_)());
      };
      (0, u.yu)(w, {
      ...
      var S = (function () {
        function e(t, n, r) {
          (0, o.Z)(this, e),
            (this.presetVersion = 3),
            (this.remoteId = ""),
            (this.name = t),
            (this.id = void 0 !== r ? r : (0, c.Z)()),
      ...
      var _ = (function () {
        ...
        return (
          (e.fromData = function (e, t, n, r, o, s) {
            return (0, i.Z)(
              a().mark(function n() {
      ...
      var k = function e() {
        (0, o.Z)(this, e),
          (this.parameters = new b()),
          (this.preset = ""),
          (this.trimResponses = !0),
          (this.banBrackets = !0),
          (this.prefix = T),
          (this.dynamicPenaltyRange = !1),
          (this.prefixMode = 0),
          (this.model = p.Ck.j6bv4);
      };
      (0, u.yu)(k, {
        parameters: (0, u.Ry)(b),
        preset: (0, u.Ru)(),
    ...
    975: function (e, t, n) {
      ...
      !(function (e) {
        (e[(e.accept = 0)] = "accept"),
          (e[(e.preventEvent = 1)] = "preventEvent"),
          (e[(e.releaseFocus = 2)] = "releaseFocus"),
          (e[(e.toggleMenuBar = 3)] = "toggleMenuBar"),
          (e[(e.toggleInfoBar = 4)] = "toggleInfoBar"),
          (e[(e.toggleBars = 5)] = "toggleBars"),
          (e[(e.toggleContextMenu = 6)] = "toggleContextMenu"),
          (e[(e.editorFocus = 7)] = "editorFocus"),
          (e[(e.editorRequest = 8)] = "editorRequest"),
          (e[(e.editorRequestInsert = 9)] = "editorRequestInsert"),
          (e[(e.editorRequestCancel = 10)] = "editorRequestCancel"),
          (e[(e.inputFocus = 11)] = "inputFocus"),
          (e[(e.inputSend = 12)] = "inputSend"),
          (e[(e.inputRedo = 13)] = "inputRedo"),
          (e[(e.inputRedoMenu = 14)] = "inputRedoMenu"),
          (e[(e.inputUndo = 15)] = "inputUndo"),
          (e[(e.inputRetry = 16)] = "inputRetry"),
          (e[(e.navigateUp = 17)] = "navigateUp"),
          (e[(e.navigateDown = 18)] = "navigateDown"),
          (e[(e.navigateLeft = 19)] = "navigateLeft"),
          (e[(e.navigateRight = 20)] = "navigateRight"),
          (e[(e.navigateMenu = 21)] = "navigateMenu"),
          (e[(e.lorebook = 22)] = "lorebook"),
          (e[(e.contextViewer = 23)] = "contextViewer"),
          (e[(e.tokenizer = 24)] = "tokenizer"),
          (e[(e.closeModal = 25)] = "closeModal"),
          (e[(e.delete = 26)] = "delete"),
          (e[(e.toggleInputBox = 27)] = "toggleInputBox"),
          (e[(e.highlighting = 28)] = "highlighting"),
          (e[(e.spellcheck = 29)] = "spellcheck"),
          (e[(e.createNewStory = 30)] = "createNewStory"),
          (e[(e.resetTheme = 31)] = "resetTheme"),
          (e[(e.deleteStory = 32)] = "deleteStory"),
          (e[(e.focusForward = 33)] = "focusForward"),
          (e[(e.focusBack = 34)] = "focusBack"),
          (e[(e.stopTTS = 35)] = "stopTTS"),
          (e[(e.tokenprob = 36)] = "tokenprob");
      })(u || (u = {}));
      var f = (function () {
          function e(t, n) {
            var r =
          ...
          return (
            (e.prototype.checkEvent = function (e, t) {
              return (
                t === this.code &&
                e.ctrlKey === this.mods.includes(r.ctrl) &&
                e.shiftKey === this.mods.includes(r.shift) &&
                e.altKey === this.mods.includes(r.alt) &&
                e.metaKey === this.mods.includes(r.meta)
              );
            }),
            e
          );
        ...
        h = (function () {
          ...
          var t = e.prototype;
          return (
            (t.addBind = function (e) {
              var t;
              (e.code = l.mergeCode(e.code)),
                this.bindMap.set(
                  e.event,
                  (0, o.Z)(
                    null !== (t = this.bindMap.get(e.event)) && void 0 !== t
                      ? t
                      : []
                  ).concat([e])
                );
            ...
            (t.setDefaults = function () {
              this.bindMap.clear(),
                this.addBind(new f(u.accept, "Enter")),
                this.addBind(new f(u.accept, "Space")),
                this.addBind(new f(u.releaseFocus, "Escape")),
                this.addBind(new f(u.toggleMenuBar, "KeyQ", [r.alt])),
                this.addBind(new f(u.toggleInfoBar, "KeyE", [r.alt])),
                this.addBind(new f(u.toggleBars, "KeyW", [r.alt])),
                this.addBind(new f(u.toggleContextMenu, "Period", [r.alt])),
                this.addBind(new f(u.editorFocus, "KeyF", [r.alt])),
                this.addBind(new f(u.editorRequest, "Enter", [r.ctrl])),
                this.addBind(new f(u.editorRequest, "Enter", [r.meta])),
                this.addBind(new f(u.editorRequest, "KeyS", [r.alt])),
                this.addBind(
                  new f(u.editorRequestInsert, "Enter", [r.shift, r.ctrl])
                ),
                this.addBind(
                  new f(u.editorRequestInsert, "Enter", [r.shift, r.meta])
                ),
                this.addBind(new f(u.inputFocus, "KeyG", [r.alt])),
                this.addBind(new f(u.inputRedo, "KeyY", [r.alt])),
                this.addBind(new f(u.inputRedoMenu, "KeyY", [r.alt, r.shift])),
                this.addBind(new f(u.inputUndo, "KeyZ", [r.alt])),
                this.addBind(new f(u.inputRetry, "KeyR", [r.alt])),
                this.addBind(new f(u.navigateUp, "ArrowUp")),
                this.addBind(new f(u.navigateDown, "ArrowDown")),
                this.addBind(new f(u.navigateLeft, "ArrowLeft")),
                this.addBind(new f(u.navigateRight, "ArrowRight")),
                this.addBind(new f(u.lorebook, "KeyL", [r.alt])),
                this.addBind(new f(u.contextViewer, "KeyK", [r.alt])),
                this.addBind(new f(u.tokenizer, "KeyT", [r.alt])),
                this.addBind(new f(u.closeModal, "Escape")),
                this.addBind(new f(u.delete, "Escape")),
                this.addBind(new f(u.delete, "Backspace")),
                this.addBind(new f(u.toggleInputBox, "KeyJ", [r.alt])),
                this.addBind(new f(u.highlighting, "KeyH", [r.alt])),
                this.addBind(new f(u.spellcheck, "KeyC", [r.alt])),
                this.addBind(new f(u.createNewStory, "KeyN", [r.alt])),
                this.addBind(new f(u.resetTheme, "KeyP", [r.alt, r.shift])),
                this.addBind(new f(u.deleteStory, "Delete", [r.alt, r.shift])),
                this.addBind(new f(u.focusForward, "Tab")),
                this.addBind(new f(u.focusBack, "Tab", [r.shift])),
                this.addBind(new f(u.stopTTS, "KeyT", [r.alt, r.shift])),
                this.addBind(new f(u.preventEvent, "AltLeft", [r.alt])),
                this.addBind(new f(u.tokenprob, "KeyT", [r.ctrl, r.alt]));
            }),
          ...
          (function () {
            function e(t, n) {
              ...
              (0, i.Z)(this, e),
                ...
                (this.keyUp = !1),
                (this.allowRepeat = !1),
                (this.enableOnTags = ["INPUT", "SELECT", "TEXTAREA"]),
                (this.enableOnContentEditable = !0),
            ...
            return (
              (e.prototype.consume = function (e) {
                ...
                if (n) {
                  if (
                    ((t = n.tagName),
                    a.includes(t) && !this.enableOnTags.includes(n.tagName))
                  )
                    return !1;
                  if (!this.enableOnContentEditable && n.isContentEditable)
                    return !1;
                }
                var r =
                ...
                return (
                  r && this.preventDefault && e.preventDefault(),
                  r && this.stopPropagation && e.stopPropagation(),
                  r
                );
              }),
              e
      ...
      (0, s.cn)({ key: "activeKeybinds", default: new h(!0) });
    },
    3427: function (e, t, n) {
      "use strict";
      n.d(t, {
      ...
      "undefined" !==
        typeof (null === (r = n.g.window) || void 0 === r
          ? void 0
          : r.document) && document.addEventListener("click", c);
      var l = function () {
        u ||
          (((u = new Audio()).src =
      ...
      "undefined" !==
        typeof (null === (i = n.g.window) || void 0 === i
          ? void 0
          : i.document) && window.addEventListener("click", l);
      ...
      var r = n(9951),
        ...
        a = function e() {
          (0, r.Z)(this, e),
            ...
            (this.paymentProcessorData = new s()),
            (this.trainingStepsLeft = 0);
        },
        u = function e() {
          (0, r.Z)(this, e),
            (this.maxPriorityActions = 0),
            (this.nextRefillAt = 0),
            (this.taskPriority = 0);
        },
        c = function e(t, n) {
          ...
          (0, r.Z)(this, e),
            ...
            (this.settings = new o.PG()),
            (this.priority = new u()),
            (this.information = new f()),
            (this.noAccount = !1),
            (this.auth_token = t),
            (this.encryption_key = n),
            (this.noAccount = i);
        },
        l = function e() {
          (0, r.Z)(this, e),
            (this.keystore = new i.tO()),
            (this.stories = new Map()),
            (this.storyContentCache = new Map()),
            (this.shelves = new Map()),
            (this.remoteStories = new Set());
        },
        f = function e() {
          (0, r.Z)(this, e),
            (this.accountCreatedAt = 0),
            (this.emailVerified = !1),
            (this.emailVerificationLetterSent = !1),
            (this.trialActivated = !1),
            (this.trialActionsLeft = 0);
        };
    },
    19: function (e, t, n) {
      "use strict";
      ...
      var r = n(1524),
        ...
        o =
          (r.env.NEXT_PUBLIC_COMMITHASH,
          r.env.NEXT_PUBLIC_SENTRY_DSN,
          r.env.NEXT_PUBLIC_BACKEND_URL || ""),
        s = "true" === r.env.NEXT_PUBLIC_MOCK_ENV,
        a =
          (r.env.NEXT_PUBLIC_RECAPTCHA_KEY,
          r.env.NEXT_PUBLIC_PADDLE_SANDBOX,
          Number.parseInt(r.env.NEXT_PUBLIC_PADDLE_VENDOR_ID || "123"),
          Number.parseInt(r.env.NEXT_PUBLIC_PADDLE_CODEX_ID || "123"),
          Number.parseInt(r.env.NEXT_PUBLIC_PADDLE_OPUS_ID || "123"),
          Number.parseInt(r.env.NEXT_PUBLIC_PADDLE_SCROLL_ID || "123"),
          Number.parseInt(r.env.NEXT_PUBLIC_PADDLE_TABLET_ID || "123"),
          Number.parseInt(
            r.env.NEXT_PUBLIC_PADDLE_GIFTKEY_TABLET_ID || "26963"
          ),
          Number.parseInt(
            r.env.NEXT_PUBLIC_PADDLE_GIFTKEY_SCROLL_ID || "27468"
          ),
          Number.parseInt(r.env.NEXT_PUBLIC_PADDLE_GIFTKEY_OPUS_ID || "27469"),
          Number.parseInt(r.env.NEXT_PUBLIC_PADDLE_GIFTKEY_CODEX_ID || "27469"),
          o + "/generate-stream"),
        u = o + "/predict-tags",
        c = 1250,
        l = 2048;
    ...
    4037: function (e, t, n) {
      ...
      !(function (e) {
        (e.unknown = "unknown"),
          (e.storyInput = "input"),
          (e.preContext = "preContext"),
          (e.postContext = "postContext"),
            ...
            return (
                ...
                if (this.canHandle(e.event)) {
                  ...
                  try {
                    ...
                    switch (e.event.eventType) {
                      case r.storyInput:
                        "function" === typeof this.script.input &&
                          (i = this.script.input(e));
                        break;
                      case r.preContext:
                        "function" === typeof this.script.preContext &&
                          (i = this.script.preContext(e));
                        break;
                      case r.postContext:
                        "function" === typeof this.script.postContext &&
                          (i = this.script.postContext(e));
                        break;
                      case r.generation:
                        "function" === typeof this.script.generation &&
                          (i = this.script.generation(e));
                    }
                    if (t) {
                      var o = !0,
                        s = !1,
                      ...
                      try {
                        for (
                          var u,
                            c = this.logParse(n, JSON.parse(JSON.stringify(i)))[
                              Symbol.iterator
                            ]();
                          !(o = (u = c.next()).done);
                          o = !0
                    ...
                    if (i)
                      return (this.remember = i.remember.getScope("me")), i;
                    e.log("Script returned invalid state!"),
                      e.log(i),
                      e.log(this);
                  } catch (h) {
                    e.log("Script error!\n" + h + "\n"), e.log(this);
              ...
              (t.logParse = function (e, t) {
                ...
                for (r.push(e, t); r.length > 0; ) {
                  ...
                  try {
                    for (
                      var c, l = Object.keys(i)[Symbol.iterator]();
                      !(s = (c = l.next()).done);
                      s = !0
                    ) {
                      var f = c.value,
                        ...
                        d = o[f];
                      h !== d && "object" !== typeof h
                        ? n.add("".concat(f, ": ").concat(h, " => ").concat(d))
                        : "object" === typeof d && null !== d && r.push(h, d);
                    }
                  } catch (p) {
                    (a = !0), (u = p);
                  } finally {
      ...
      !(function (e) {
        (e.Included = "included"),
          (e.PartiallyIncluded = "partially included"),
          (e.NotIncluded = "not included");
      })(d || (d = {})),
        (function (e) {
          (e.Default = "default"),
            (e.NoSpace = "no space"),
            (e.Disabled = "disabled"),
            (e.NoKeyTriggered = "no key"),
            (e.KeyTriggered = "key activated"),
            (e.KeyTriggeredNonStory = "key in: "),
            (e.ActivationForced = "activation forced"),
            (e.NoText = "no text"),
            (e.NoContextKey = "no key in context"),
            (e.EphemeralActive = "ephemeral active"),
            (e.EphemeralInactive = "ephemeral inactive"),
            (e.NoActiveEntries = "no active entries");
        })(p || (p = {})),
        (function (e) {
          (e.NoTrim = "no trim"),
            (e.Token = "token"),
      ...
      var w = function e() {
        (0, i.Z)(this, e),
          ...
          (this.output = ""),
          (this.tokens = []),
          (this.contextStatuses = []),
          (this.spacesTrimmed = 0),
          (this.structuredOutput = []),
          (this.stageReports = []),
          (this.keyRejections = []),
          (this.disabled = []),
          (this.orderZeroPoint = 0),
          (this.biases = []),
          (this.storyTrimmed = !1),
          (this.tokenizerType = m._E.GPT2),
          (this.preamble = { str: "", tokens: [] });
      };
      new Map();
      new Set([
        ".",
      ...
      var S,
        ...
        I = (function () {
          function e(t, n, r) {
            ...
            (0, i.Z)(this, e),
              ...
              (this.parsers = o),
              (this.shortcuts = s),
              (this.shortcutIgnores = a),
              (this.placeholderText = c),
              u && (this.node = u);
          }
          var t = e.prototype;
          return (
            (t.consumeShortcuts = function (e) {
              var t = e,
                n = !1,
                r = !0,
                i = !1,
              ...
              try {
                for (
                  var s, a = this.shortcuts[Symbol.iterator]();
                  !(r = (s = a.next()).done);
                  r = !0
                ) {
            ...
            (t.stringIsNode = function (e) {
              ...
              return (
                !!(null === (t = this.node) || void 0 === t
                  ? void 0
                  : t.regex) && this.node.regex.test(e)
              );
            }),
            e
          );
          ...
          (new (n(288).V_)({
            nodes: {
              ...
              adventureInput: {
                ...
                toDOM: function (e) {
                  return ["p", { class: "adventureInput " + e.attrs.name }, 0];
                },
              },
              adventureStory: {
                group: "block",
          ...
          return (
            (e.prototype.input = function (e) {
              if (!e.remember.get("event/inputIsEmpty")) {
                if (
                  ((e.event.inputText = e.event.inputText.trim()),
                  0 === e.event.inputText.length)
                ) {
                  ...
                  e.event.inputText = (0, h.BP)("> You", e.event.inputText);
                !e.remember.get("event/inputIsUppercase") &&
                  (0, h.Lj)(e.event.inputText.charAt(0)) &&
                  1 ===
                    (0, R.Z)(e.event.inputText).filter(function (e) {
                      return (0, h.Lj)(e);
                    }).length &&
                  (e.event.inputText =
                    e.event.inputText.charAt(0).toLowerCase() +
                    e.event.inputText.slice(1)),
                  (e.event.inputText =
                    e.event.inputText.length > 0
                      ? "> You"
                          .concat(
                            /^['\u2019]/.test(e.event.inputText) ? "" : " "
                          )
                          .concat(e.event.inputText)
                      : ">"),
                  e.event.storyText.length > 0 &&
                    (e.event.inputText = "\n" + e.event.inputText);
              }
              return e;
            }),
            ...
            (e.prototype.input = function (e) {
              if (!e.remember.get("event/inputIsEmpty")) {
                var t = "",
                  ...
                  s = [];
                e.remember.get("event/moods/neutral") &&
                  (s = e.remember.getStringArray("moods/adverbs/say/simple")),
                  (e.event.inputText = e.event.inputText.trim()),
                  (e.event.inputText = (0, h.BP)(
                    '> You say "',
                    e.event.inputText,
                    !0
                  )),
                  h.Sh.has(e.event.inputText.charAt(0)) &&
                    (e.event.inputText = e.event.inputText.slice(1)),
                  h.Sh.has(
                    e.event.inputText.charAt(e.event.inputText.length - 1)
                  ) &&
                    !e.remember.get("event/inputIsWildcard") &&
                    (e.event.inputText = e.event.inputText.slice(0, -1));
                var a = e.remember.getNumber("me/adverbChance");
                if (
                  (a <= 0 && (a = Math.floor(10 * Math.random()) / 10),
                  r.length > 0)
                ) {
                  ...
                  if (c.length > 1) {
                    ...
                    for (
                      ...
                      v === u
                        ...
                        : p
                        ? (p = !1)
                        : (c[g] = 0.5 >= Math.random() ? "and " + v : ", " + v),
                        g++;
                    }
                  }
                  i.length > 0 &&
                    Math.random() > 0.1 &&
                    (t += i[Math.floor(Math.random()) * i.length] + " and ");
                  var y = !0,
                    m = !1,
                    b = void 0;
                  try {
                    for (
                      var w, S = c[Symbol.iterator]();
                      !(y = (w = S.next()).done);
                      y = !0
                    ) {
                      var x = w.value;
                ...
                a < 1.5 &&
                  e.remember.set(
                    "me/adverbChance",
                    Math.min(Math.max(a, 0.1) + 0.05, 1.1)
                  ),
                  (e.event.inputText =
                    e.event.inputText.charAt(0).toUpperCase() +
                    e.event.inputText.slice(1)),
                  (e.event.inputText = "> You " + t + '"' + e.event.inputText),
                  e.event.storyText.length > 0 &&
                    (e.event.inputText = "\n" + e.event.inputText),
                  e.remember.get("event/inputIsWildcard") ||
                    ((e.event.inputText += '"'),
                    o.length > 0 &&
                      Math.random() > 0.95 &&
                      (n += " " + o[Math.floor(Math.random() * n.length)]),
                    (e.event.inputText += n));
              }
              return e;
            }),
        ...
        U = (function () {
          ...
          return (
            (e.prototype.input = function (e) {
              return (
                0 === e.event.originalInputText.length &&
                  e.remember.set("event/inputIsEmpty", !0),
                e
              );
            }),
            e
        ...
        j = (function () {
          ...
          return (
            (e.prototype.input = function (e) {
              if (
                !e.remember.get("event/inputIsWildcard") &&
                !e.remember.get("event/inputIsEmpty")
              ) {
                var t = h.Sh.has(
                  e.event.inputText.charAt(e.event.inputText.length - 1)
                )
                  ...
                  : "";
                if (
                  (t && (e.event.inputText = e.event.inputText.slice(0, -1)),
                  !h.km.has(
                    e.event.inputText.charAt(e.event.inputText.length - 1)
                  ))
                ) {
                  ...
                  e.log(n),
                    (e.event.inputText +=
                      n.get("action") || n.get("scream") ? "!" : ".");
                }
                e.remember.get("event/inputIsUppercase") &&
                  (e.event.inputText = e.event.inputText.toUpperCase()),
                  (e.event.inputText += t + "\n");
              }
              return e;
            }),
        ...
        F = (function () {
          ...
          return (
            (e.prototype.input = function (e) {
              var t = e.event.originalInputText.split(" ").pop();
              t || (t = e.event.originalInputText),
                t.includes("?") &&
                  (e.remember.set("event/moods/wonder", !0),
                  e.remember.add("event/moods/verbs/say/wonder", ["ask"]),
                  e.remember.add("event/moods/verbs/do/wonder", [
                    "question",
                    "ask",
                    "inquire",
                    "think",
                ...
                t.includes("!") &&
                  (e.remember.set("event/moods/action", !0),
                  e.remember.add("event/moods/verbs/say/action", [
                    "yell",
                    "shout",
                  ]),
                  e.remember.add("event/moods/verbs/do/action", [
                    "wriggle",
                    "bounce",
                    "bump",
                    "fling",
                ...
                (0, h.Lj)(e.event.inputText) &&
                  (e.remember.set("event/moods/scream", !0),
                  e.remember.set("event/inputIsUppercase", !0),
                  e.remember.add("event/moods/verbs/say/action", [
                    "yell",
                    "shout",
                  ])),
                e.remember.get("event/inputIsInterruption") &&
                  e.remember.add("event/moods/preverbs/say/interruption", [
                    "interrupt",
                  ]),
                /^\w+[!.?]?$/.test(e.event.inputText) &&
                  (e.remember.set("event/moods/simple", !0),
                  e.remember.add("event/moods/adverbs/say/simple", [
                    "plainly",
                    "simply",
                  ])),
                e.remember.has("moods/verbs/say") ||
                  (e.remember.set("event/moods/verbs/say/neutral", ["say"]),
                  e.remember.set("event/moods/neutral", !0)),
                t.includes("...") &&
                  (e.remember.set("event/moods/ellipsis", !0),
                  e.remember.add("event/moods/verbs/say/ellipsis", [
                    "groan",
                    "sigh",
                    "grumble",
                  ]),
                  e.remember.add("event/moods/postverbs/say/ellipsis", [
                    "and trail off",
                  ]));
              var n = e.remember.getArray("me/lastInputs");
              return (
                n.includes(e.event.inputText) &&
                  !e.remember.get("event/inputIsWildcard") &&
                  (e.remember.set("event/moods/repeat", !0),
                  e.remember.add("event/moods/verbs/say/repeat", [
                    "repeat",
                    "restate",
                    "echo",
                  ]),
                  e.remember.add("event/moods/postverbs/say/repeat", "again")),
                n.push(e.event.originalInputText),
                n.length > 3 && n.shift(),
                e.remember.set("me/lastInputs", n),
                e
              );
            }),
            e
          ...
          return (
            (e.prototype.input = function (e) {
              ...
              return (
                0 === e.event.inputText.length
                  ? (t = !0)
                  : e.event.inputText.endsWith("*") &&
                    (0, R.Z)(e.event.inputText.matchAll(/\*/g)).length % 2 !== 0
                  ? ((t = !0),
                    (e.event.inputText = e.event.inputText.slice(0, -1)))
                  : (e.event.inputText.toLowerCase().endsWith(" and") ||
                      h.Wf.has(
                        e.event.inputText.charAt(e.event.inputText.length - 1)
                      )) &&
                    (t = !0),
                ["!", "?"].includes(e.event.inputText) &&
                  ((e.event.inputText = ""), (t = !0)),
                t && e.remember.set("event/inputIsWildcard", !0),
                e
              );
            }),
            e
          ...
          return (
            (e.prototype.input = function (e) {
              if (e.event.inputText.length > 0) {
                for (
                  var t = (0, h.O5)(e.event.storyText), n = 0, r = "", i = 0;
                  i < t.length;
                ...
                if (
                  (h.Wf.has(t.charAt(t.length - 1)) &&
                    !h.Wf.has(t.charAt(t.length - 2)) &&
                    (n += -1),
                  !h.km.has(t.charAt(t.length - 1 + n)) &&
                    !h.h8.has(t.charAt(t.length - 1 + n)))
                ) {
                  var s = !1,
                    a = !0,
                    u = !1,
                  ...
                  try {
                    for (
                      ...
                      if (r.includes(d)) {
                        (r = "\u2014" + r),
                          (s = !0),
                          e.remember.set("event/inputIsInterruption", !0);
                        break;
                      }
                    }
                  } catch (p) {
                ...
                0 !== n && (e.event.storyText = e.event.storyText.slice(0, n)),
                  (e.event.storyText += r);
              }
              return e;
            }),
          ...
          return (
            (e.prototype.input = function (e) {
              ...
              return (
                D.SE ||
                  t.push(
                    "Tip: Right-click on the story to open the context menu"
                  ),
                e.remember.set(
                  "mode/metadata/placeholderText",
                  t[Math.floor(Math.random() * t.length)]
                ),
                e
              );
            ...
            (e.prototype.input = function (e) {
              ...
              try {
                for (
                  ...
                  a[0].startsWith("I") ||
                    a[0].startsWith("i") ||
                    (t.set(a[0].toLowerCase(), a[1].toLowerCase()),
                    t.set(a[0].toUpperCase(), a[1].toUpperCase()));
                }
              } catch (P) {
                (r = !0), (i = P);
              } finally {
              ...
              try {
                for (
                  var d, p = u.entries()[Symbol.iterator]();
                  !(c = (d = p.next()).done);
                  c = !0
                ) {
                  ...
                  if (g % 2 !== 1) {
                    ...
                    try {
                      for (
                        var b, w = t.entries()[Symbol.iterator]();
                        !(v = (b = w.next()).done);
                        v = !0
                      ) {
                        ...
                        if (x.startsWith("I") || x.startsWith("i")) {
                          for (var k = 0, T = u.join(""), E = 0; E < g; E++)
                            k += u[E].length;
                          if ((0, h.Lj)(u[g])) {
                            u[g] = u[g].replace(
                              new RegExp("\\b".concat(x, "\\b"), "g"),
                              _.toUpperCase()
                            );
                            continue;
                          }
                          ...
                          try {
                            for (
                              var N, M = R[Symbol.iterator]();
                              !(I = (N = M.next()).done);
                              I = !0
                            ) {
                              var V,
                                B =
                                  (null !== (V = N.value.index) && void 0 !== V
                                    ? V
                                    : -1) + C;
                              h.h8.has(T.charAt(k + B - 2))
                                ? h.km.has(T.charAt(k + B - 3))
                                  ? (u[g] =
                                      u[g].slice(0, B) +
                                      _ +
                                      u[g].slice(B + x.length))
                                  : (u[g] =
                                      u[g].slice(0, B) +
                                      _.toLowerCase() +
                                      u[g].slice(B + x.length))
                                : h.km.has(T.charAt(k + B - 2))
                                ? (u[g] =
                                    u[g].slice(0, B) +
                                    _ +
                                    u[g].slice(B + x.length))
        ...
        H = new I(
          ...
          [RegExp('^"(.*)', "s")],
          [],
          new O("adventureSay", M.Z, /^> You \S* "/)
        ),
        W = new I(
          "STORY",
          N.Z,
          [1, 0],
          [new y(new U()), new y(new L()), new y(new q())],
          [RegExp("^!(.{2,})", "s")],
          ["SAY"]
        ),
        G = (function () {
        ...
        Y =
          (new I(
            ...
            N.Z,
            [1],
            [new y(new U()), new y(new G()), new y(new Z())],
            [RegExp('^"(.*)', "s")]
          ),
          [$, H, W]),
        J = n(8906),
        X = n(4564),
        Q = (0, s.cn)({ key: "session", default: new a.n5("", "") }),
        ee = (0, s.CG)({
          key: "sessionvalue",
          get: function (e) {
            return function (t) {
          ...
          (0, s.cn)({
            ...
            default: new (function e() {
              (0, i.Z)(this, e),
                ...
                (this.tokenizer = m._E.GPT2);
            })(),
          }),
          (0, s.cn)({ key: "stories", default: new Array() }),
          (0, s.cn)({ key: "shelves", default: new Array() }),
          (0, s.cn)({ key: "selectedShelf", default: "" }),
          function e(t, n, r, o, s) {
            (0, i.Z)(this, e),
              (this.id = null !== t && void 0 !== t ? t : ""),
              (this.update = n),
              (this.loaded = r),
              (this.selected = o),
              (this.error = s);
          }),
        ne = (0, s.xu)({ key: "storyStates", default: new te("") }),
        re = (0, s.cn)({ key: "selectedStoryValue", default: new te("") }),
        ie = (0, s.CG)({
          key: "storyUpdate",
          get: function (e) {
            return function (t) {
            ...
            return function (t, n) {
              ...
              if ((0, o.Z)(n, s.nY)) i(ne(e), n);
                ...
                var a,
                  ...
                  m = new te(
                    null !==
                      (u = null !== (a = n.id) && void 0 !== a ? a : y.id) &&
                    void 0 !== u
                      ? u
                      : "",
                    (null !== (c = n.update) && void 0 !== c ? c : 0) ==
                    (null !== (l = y.update) && void 0 !== l ? l : 0)
                      ? (null !== (f = n.update) && void 0 !== f ? f : 0) + 1
                      : (null !== (h = n.update) && void 0 !== h ? h : 0) +
                        (null !== (d = y.update) && void 0 !== d ? d : 0),
                    null !== (p = n.loaded) && void 0 !== p ? p : y.loaded,
                    null !== (g = n.selected) && void 0 !== g ? g : y.selected,
                    null !== (v = n.error) && void 0 !== v ? v : y.error
                  );
        ...
        oe =
            ...
            set: function (e, t) {
              ...
              if ((0, o.Z)(t, s.nY)) n(re, t);
                ...
                n(ie(t.id), function (e) {
                  return new te(
                    t.id,
                    null !== (i = t.update) && void 0 !== i ? i : e.update,
                    null !== (a = t.loaded) && void 0 !== a ? a : e.loaded,
                    !0,
                    t.error
                  );
                });
          ...
          (0, s.nZ)({
            key: "selectedStoryId",
            get: function (e) {
              return (0, e.get)(re).id;
            },
          }),
          (0, s.nZ)({
            key: "selectedStoryLoaded",
            get: function (e) {
              return (0, e.get)(re).loaded || !1;
            },
          }),
          (0, s.nZ)({
            ...
            get: function (e) {
              var t = (0, e.get)(re).id,
                ...
                r = X.s.stories.get(t);
              return (
                (null === n || void 0 === n ? void 0 : n.settingsDirty) ||
                (null === r || void 0 === r ? void 0 : r.isModified) ||
                !!(null === n || void 0 === n ? void 0 : n.getStoryText())
              );
            },
          }),
          (0, s.nZ)({
            ...
            get: function (e) {
              ...
              return null !==
                (S =
                  null === (t = X.s.storyContentCache.get(n(re).id)) ||
                  void 0 === t
                    ? void 0
                    : t.settings.prefixMode) && void 0 !== S
                ? S
                : J.xq.normal;
            },
          }),
          ...
          (0, s.nZ)({
            ...
            get: function (e) {
              var t = e.get;
              return null !== (k = t(re).error) && void 0 !== k ? k : "";
            },
          }),
          (0, s.cn)({ key: "generationRequestActive", default: !1 }),
          (0, s.cn)({ key: "generationRequestCancelled", default: !1 }),
          (0, s.cn)({ key: "generationRequestError", default: "" }),
          (0, s.cn)({ key: "siteTheme", default: u.L })),
        se = (0, s.cn)({ key: "modalOpen", default: 0 });
      (0, s.cn)({ key: "splashModalOpen", default: void 0 }),
        (0, s.cn)({ key: "settingsModalOpen", default: -1 }),
        (0, s.cn)({ key: "saveStatus", default: "" }),
        (0, s.cn)({
          key: "subscriptionDialogOpen",
          default: { open: !1, blocked: !1 },
        }),
        (0, s.cn)({ key: "lorebookOpen", default: !1 }),
        (0, s.cn)({ key: "seleectedlorebookentry", default: "" }),
        (0, s.cn)({
          key: "lorebookgenerateclipboard",
          default: { text: "", group: "" },
        }),
        (0, s.cn)({ key: "lorebookgeneratekeysinput", default: "" }),
        (0, s.cn)({ key: "tokenProbOpen", default: !1 }),
        (0, s.cn)({ key: "presets", default: new Array() }),
        (0, s.cn)({ key: "modules", default: new Array() }),
        (0, s.cn)({ key: "updatenotesvisible", default: !1 }),
        (0, s.cn)({ key: "updatenotesunread", default: !1 }),
        (0, s.cn)({ key: "updatenotes", default: new Array() }),
        (0, s.cn)({ key: "prefixtrainingopen", default: !1 }),
        (0, s.cn)({
          key: "inputmodes",
          default: Y,
          dangerouslyAllowMutability: !0,
        ...
        (0, s.cn)({ key: "contextviewer", default: -1 }),
        (0, s.cn)({ key: "tokenizeropen", default: !1 }),
        (0, s.cn)({ key: "tokenizertext", default: "" }),
        (0, s.cn)({ key: "storysearch", default: "" }),
        (0, s.cn)({
          key: "storysort",
          default: {
            reverse: !1,
            by: { label: "Most Recent", value: "recent" },
          },
        }),
        (0, s.cn)({ key: "scenarioSelected", default: 0 }),
        (0, s.cn)({ key: "loresearch", default: "" }),
        (0, s.cn)({
          key: "loresort",
          default: {
            reverse: !1,
            by: { label: "Alphabetical", value: "alphabetical" },
          },
        }),
        (0, s.cn)({ key: "userpromptmodal", default: null }),
        (0, s.cn)({
          key: "tutorial",
          default: { state: -1, next: function () {}, prev: function () {} },
        }),
        (0, s.cn)({ key: "menubaropen", default: !1 }),
        (0, s.cn)({ key: "infobaropen", default: !1 }),
        (0, s.cn)({ key: "showtutorial", default: !1 }),
        (0, s.cn)({ key: "remoteSaveFailed", default: "" }),
        (0, s.cn)({ key: "appUpdateAvailable", default: !1 }),
        (0, s.cn)({ key: "themePreview", default: u.L }),
        (0, s.cn)({ key: "trialRemainingActions", default: 0 }),
        (0, s.cn)({ key: "trialUsed", default: !1 }),
        (0, s.cn)({ key: "ipLimitModal", default: !1 }),
        (0, s.cn)({ key: "lorebookGenerateOpen", default: !1 }),
        (0, s.cn)({ key: "lorebookGenerateExpanded", default: !1 }),
        (0, s.cn)({ key: "infobarSelectedTab", default: 0 });
      !(function (e) {
        (e.Entry = "tab-entry"),
          (e.Context = "tab-context"),
          (e.Bias = "tab-bias"),
          (e.None = "");
      })(T || (T = {})),
        (function (e) {
          (e.Defaults = "tab-category-defaults"),
            (e.Subcontext = "tab-category-subcontext"),
            (e.Bias = "tab-category-bias"),
            (e.None = "");
        })(E || (E = {}));
      (0, s.cn)({
        key: "lorebookTabs",
        ...
        (0, s.cn)({ key: "giftKeyOpen", default: !1 }),
        (0, s.cn)({
          key: "screenshotState",
          default: { open: !1, start: 0, end: 0 },
        }),
        (0, s.cn)({ key: "debugSettings", default: !1 }),
        (0, s.cn)({
          key: "ttsState",
          default: { paused: !1, stopped: !0, commentSpeaking: !1 },
        }),
        (0, s.cn)({
          key: "commentState",
          default: {
        ...
        (0, s.cn)({ key: "tipState", default: { tip: -1, easterEggTip: -1 } }),
        (0, s.cn)({ key: "checkEditor", default: 0 });
    },
    8199: function (e, t, n) {
      "use strict";
      n.r(t),
      ...
      var i = n(3712),
        ...
        m = n(3216),
        b = n(789);
      function w({ children: e, isValidProp: t, ...n }) {
        t && (0, m.K)(t),
          ((n = { ...(0, p.useContext)(y._), ...n }).isStatic = (0, b.h)(
            () => n.isStatic
          ));
        const r = (0, p.useMemo)(
          () => n,
        ...
        return p.createElement(y._.Provider, { value: r }, e);
      }
      var S = n(7265);
      function x(e) {
        return (
      ...
      function A(e, t, n) {
        ...
        return (
          h({ type: T.INIT }),
          ((r = { dispatch: h, subscribe: f, getState: l, replaceReducer: d })[
            _
          ] = p),
          r
        );
      ...
      var R = n(1524);
      function C(e, t, ...n) {
        if ("undefined" !== typeof R && void 0 === t)
      ...
      function U(e) {
        return function (t = [], n = { publishSource: !0 }) {
          ...
          e.dispatch(P(i)),
            (function (e, t, n) {
              C(!t.isDragging(), "Cannot call beginDrag while dragging."),
          ...
          e.dispatch(P(i, c));
          const l = a.getSource(u).beginDrag(s, u);
          if (null == l) return;
          !(function (e) {
      ...
      function z(e) {
        return function (t = {}) {
          const n = e.getMonitor(),
            r = e.getRegistry();
          !(function (e) {
            C(e.isDragging(), "Cannot call drop while not dragging."),
              C(
                !e.didDrop(),
          ...
          i.forEach((i, o) => {
            const s = (function (e, t, n, r) {
                ...
                (function (e) {
                  ...
                  "undefined" === typeof o &&
                    (o = 0 === t ? {} : r.getDropResult());
                return o;
              })(i, o, r, n),
              a = { type: V, payload: { dropResult: F({}, t, s) } };
            e.dispatch(a);
          });
        };
      }
      ...
      function K(e) {
        return function (t, { clientOffset: n } = {}) {
          ...
          return (
            ...
            (function (e, t, n) {
              C(t.isDragging(), "Cannot call hover while not dragging."),
                C(!t.didDrop(), "Cannot call hover after drop.");
            ...
            { type: M, payload: { targetIds: r, clientOffset: n || null } }
          );
        };
      }
      function $(e) {
        return function () {
          if (e.getMonitor().isDragging()) return { type: N };
        };
      }
      class H {
        receiveBackend(e) {
      ...
      class J {
                ...
                (i === r + 1 &&
                  !(function (e, t) {
                    return (
                      ...
                      (e === Y ||
                        "undefined" === typeof t ||
                        ((n = e), t.filter((e) => n.indexOf(e) > -1)).length >
                          0)
                    );
                    var n;
                  })(t.dirtyHandlerIds, n));
        ...
        canDragSource(e) {
          ...
          return (
            C(t, `Expected to find a valid source. sourceId=${e}`),
        ...
        canDropOnTarget(e) {
          ...
          if (
            (C(t, `Expected to find a valid target. targetId=${e}`),
            !this.isDragging() || this.didDrop())
          )
            return !1;
          return (
            q(this.registry.getTargetType(e), this.getItemType()) &&
            t.canDrop(this, e)
          );
        }
        isDragging() {
      ...
      const re = new (class {
          ...
          constructor() {
            (this.queue = []),
              ...
              (this.requestFlush = te(this.flush)),
              (this.requestErrorThrow = ee(() => {
        ...
        ie = new (class {
          create(e) {
            const t = this.freeTasks,
              n = t.length
                ? t.pop()
                : new ne(this.onError, (e) => (t[t.length] = e));
            return (n.task = e), n;
          }
          constructor(e) {
      ...
      class ge {
        ...
        getTarget(e) {
          return (
            C(this.isTargetId(e), "Expected a valid target ID."),
        ...
        removeSource(e) {
          var t;
          C(this.getSource(e), "Expected an existing source."),
            this.store.dispatch(
              (function (e) {
        ...
        removeTarget(e) {
          C(this.getTarget(e), "Expected an existing target."),
            this.store.dispatch(
              (function (e) {
                return { type: ue, payload: { targetId: e } };
              })(e)
            ),
        ...
        pinSource(e) {
          ...
          C(t, "Expected an existing source."),
            (this.pinnedSourceId = e),
            (this.pinnedSource = t);
        }
        unpinSource() {
          C(this.pinnedSource, "No source is pinned at the time."),
        ...
        addHandler(e, t, n) {
          ...
          return (
            ...
            e === le.SOURCE
              ...
              : e === le.TARGET && this.dropTargets.set(r, n),
            r
          );
        }
        constructor(e) {
      ...
      function ke(e = _e, t) {
        ...
        switch (t.type) {
          ...
          case N:
            return xe({}, e, { isSourcePublic: !0 });
          case M:
            return xe({}, e, { targetIds: n.targetIds });
          case ue:
      ...
      const Oe = (0, p.createContext)({ dragDropManager: void 0 });
      function De(e, t) {
        if (null == e) return {};
        var n,
          r,
      ...
      var Ve = (0, p.memo)(function (e) {
        ...
        const [r, i] = (function (e) {
          ...
          const t = (function (e, t = Be(), n, r) {
              const i = t;
              i[Me] || (i[Me] = { dragDropManager: Ie(e, t, n, r) });
              return i[Me];
        ...
        return (
          ...
          (0, a.jsx)(Oe.Provider, { value: r, children: t })
        );
      });
      function Be() {
      ...
      class Le {
        ...
        leave(e) {
          ...
          return (
            (this.entered =
              ((n = this.entered.filter(this.isNodeInDocument)),
              (r = e),
              n.filter((e) => e !== r))),
      ...
      function $e(e) {
        ...
        return (
          Object.keys(Ke).filter((e) => {
            const n = Ke[e];
            return (
              !!(null === n || void 0 === n ? void 0 : n.matchesTypes) &&
              n.matchesTypes.some((e) => t.indexOf(e) > -1)
            );
          })[0] || null
        );
      }
      ...
      class Ge {
        interpolate(e) {
          const { xs: t, ys: n, c1s: r, c2s: i, c3s: o } = this;
          let s = t.length - 1;
          if (e === t[s]) return n[s];
          let a,
            u = 0,
      ...
      function Xe(e, t, n, r, i) {
        const o = (function (e) {
          ...
          s = Ye(o ? e : t),
          a = { x: n.x - s.x, y: n.y - s.y },
          { offsetWidth: u, offsetHeight: c } = e,
          { anchorX: l, anchorY: f } = r,
          { dragPreviewWidth: h, dragPreviewHeight: d } = (function (
            e,
            t,
            n,
            r
          ...
          (this.sourcePreviewNodes = new Map()),
            ...
            (this.handleTopDragEnter = (e) => {
              ...
              (this.altKeyPressed = e.altKey),
                t.length > 0 && this.actions.hover(t, { clientOffset: Je(e) });
              ...
              ((this.dropTargetIds = []), this.isDraggingNativeItem())
                ? (e.preventDefault(),
                  null === (t = this.currentNativeSource) ||
                    void 0 === t ||
                    t.loadDataTransfer(e.dataTransfer))
                : $e(e.dataTransfer) && e.preventDefault();
              this.enterLeaveCounter.reset();
            }),
            (this.handleTopDrop = (e) => {
              const { dropTargetIds: t } = this;
              (this.dropTargetIds = []),
                this.actions.hover(t, { clientOffset: Je(e) }),
      ...
      var lt = (0, d.vJ)(ut(), function (e) {
        ...
        ft = (0, d.vJ)(
          ...
          function (e) {
            return (0, at.DZ)(0.4, e.theme.colors.textMain);
          },
          function (e) {
            return e.theme.fonts.field;
          },
          ...
          function (e) {
            return e.editorHighlighting
              ? e.theme.colors.textPrompt
              : e.theme.colors.textMain;
          },
          function (e) {
            return e.theme.colors.textPlaceholder;
          },
          ...
          function (e) {
            return (0, at.DZ)(0.5, e.theme.colors.textHeadings);
          },
          function (e) {
            return e.theme.colors.textHighlight;
          },
          function (e) {
            return e.editorHighlighting
              ? e.theme.colors.textAI
              : e.theme.colors.textMain;
          },
          function (e) {
            return e.editorHighlighting
              ? e.theme.colors.textUser
              : e.theme.colors.textMain;
          },
          function (e) {
            return e.editorHighlighting
              ? e.theme.colors.textEdit
              : e.theme.colors.textMain;
          },
          function (e) {
            return e.editorHighlighting
        ...
        gt = n(7044);
      if (
        (c().events.on("routeChangeStart", function (e) {
          return e.startsWith("/stories?id=") || v().start();
        }),
        c().events.on("routeChangeComplete", function (e) {
          return e.startsWith("/stories?id=") || v().done();
        }),
          ...
          return (0, o.Z)((0, i.Z)({}, e), {
            warn: function () {
              for (
                ...
                n[r] = arguments[r];
              var i, o, a, u;
              return (null === (a = n[0]) || void 0 === a ? void 0 : a.includes)
                ? (
                    null === (u = n[0]) || void 0 === u
                      ? void 0
                      : u.includes("Duplicate atom key")
                  )
                  ? null
                  : (i = e).warn.apply(i, (0, s.Z)(n))
                : (o = e).warn.apply(o, (0, s.Z)(n));
            },
          });
        });
      ...
      function yt(e) {
        ...
        (0, p.useEffect)(function () {
          (0, ht.S2)(ht.uC.focusForward, new ht.kl("indexTabF", v, !1, !1, !1)),
            (0, ht.S2)(ht.uC.focusBack, new ht.kl("indexTabB", v, !1, !1, !1)),
            (0, ht.S2)(
              ht.uC.preventEvent,
              new ht.kl("indexPrevent", function (e) {
        ...
        return (0, a.jsxs)(a.Fragment, {
          children: [
            ...
            (0, a.jsx)(d.f6, {
              theme: u,
              children: b((0, a.jsx)(n, (0, o.Z)((0, i.Z)({}, r), { err: s }))),
            }),
          ],
        });
      }
      var mt = function (e) {
        return (0, a.jsxs)(a.Fragment, {
          children: [
            (0, a.jsxs)(f(), {
              children: [
                (0, a.jsx)("meta", { name: "referrer", content: "origin" }),
                (0, a.jsx)("meta", { charSet: "utf8" }),
                (0, a.jsx)("meta", {
                  name: "viewport",
                  content:
                ...
                (0, a.jsx)("meta", {
                  name: "keywords",
                  content:
                    "ai, adventure, writing, novelai, novel ai, anlatan, ai dungeon, aidungeon, openai, \\ nai, games, computer, videogames, text, textadventure, novel, kurumuz, latitude",
                }),
                (0, a.jsx)("meta", {
                ...
                (0, a.jsx)("meta", { httpEquiv: "Expires", content: "0" }),
                (0, a.jsx)("meta", {
                  httpEquiv: "X-UA-Compatible",
                  content: "IE=edge",
                }),
                (0, a.jsx)("meta", { name: "darkreader", content: "disable" }),
              ],
            }),
            (0, a.jsx)(h.Wh, {
              children: (0, a.jsx)(w, {
    ...
    563: function (e, t, n) {
      ...
      var r = {
        ...
        breakpoints: { mobile: "1200px", desktop: "1600px" },
        transitions: { interactive: "0.08s ease-in-out" },
        global: "",
      };
    },
    1854: function (e, t, n) {
      ...
      var o = function (e, t) {
          return (0, i.Z)(Array.from({ length: t }).keys()).slice(e);
        },
        s = function (e) {
      ...
      var a = (function () {
          for (
            var e = (0, i.Z)(o(s("!"), s("~") + 1)).concat(
                (0, i.Z)(o(s("\xa1"), s("\xac") + 1)),
                (0, i.Z)(o(s("\xae"), s("\xff") + 1))
              ),
              t = (0, i.Z)(e),
              n = 0,
              r = 0;
            ...
            e.includes(r) || (e.push(r), t.push(Math.pow(2, 8) + n), (n += 1));
          t = t.map(function (e) {
            return (function (e) {
          ...
          return (
                ...
                var a = (0, c.Z)(),
                  ...
                  l = function (e) {
                    ...
                    t.id === a &&
                      ...
                      t.error ? i(t.error) : r(t.data));
                  };
                null === d || void 0 === d || d.addEventListener("message", l),
                  null === d ||
                    void 0 === d ||
                    d.postMessage((0, s.Z)((0, o.Z)({}, e), { id: a }));
              });
            }),
            (t.encode = function (e, t) {
              ...
              return this.postMessage(
                { task: "encode", data: e, encoderType: t },
                n,
            ...
            (t.decode = function (e, t) {
              var n =
                arguments.length > 2 && void 0 !== arguments[2]
                  ...
                  : 2e4;
              return this.postMessage(
                { task: "decode", data: e, encoderType: t },
                n,
    ...
    4297: function (e, t, n) {
          ...
          this._executeHandlers = () => {
            if (this._state !== h.PENDING) {
              ...
              (this._handlers = []),
                e.forEach((e) => {
                  e[0] ||
                    (this._state === h.RESOLVED && e[1](this._value),
                    this._state === h.REJECTED && e[2](this._value),
                    (e[0] = !0));
                });
            }
          };
      ...
      function w(e, t) {
        if (v(e)) {
          ...
          for (var r of (t.set(e, n), Object.keys(e)))
            "undefined" !== typeof e[r] && (n[r] = w(e[r], t));
          return n;
        }
        if (Array.isArray(e)) {
          var i;
      ...
      function x(e, t = {}) {
        if (
          ...
          (e.timestamp = t.timestamp || (0, s.ph)()),
      ...
      class _ {
        ...
        setUser(e) {
          return (
            (this._user = e || {}),
            this._session && x(this._session, { user: e }),
            ...
            if (null === t || "function" !== typeof s) i(t);
              ...
              ("undefined" === typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) &&
                ...
                y(a)
                  ? a
                      .then((t) =>
                        this._notifyEventProcessors(e, t, n, r + 1).then(i)
                      )
                      .then(null, o)
      ...
      class E {
        ...
        addBreadcrumb(e, t) {
          ...
          if (!n || !r) return;
          const { beforeBreadcrumb: i = null, maxBreadcrumbs: o = T } =
            (r.getOptions && r.getOptions()) || {};
          if (!(o <= 0)) {
            var a = { timestamp: (0, s.yW)(), ...e },
              u = i ? c(() => i(a, t)) : a;
        ...
        startSession(e) {
          ...
          if (t) {
            ...
            c && "ok" === c.status && x(c, { status: "exited" }),
              this.endSession(),
              t.setSession(u);
          }
          return u;
        ...
        _callExtensionMethod(e, ...t) {
          ...
          ("undefined" === typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) &&
            f.warn(`Extension method ${e} couldn't be found, doing nothing.`);
        }
      }
      function A() {
        var e = (0, i.R)();
      ...
      function C() {
        var e = A();
        return (
          (I(e) && !O(e).isOlderThan(4)) || D(e, new E()),
          (0, d.KV)()
            ? (function (e) {
                try {
                  var t = A().__SENTRY__,
                  ...
                  if (!n) return O(e);
                  if (!I(n) || O(n).isOlderThan(4)) {
                    var r = O(e).getStackTop();
      ...
      function N(e, t) {
        return C().captureException(e, { captureContext: t });
      }
      function M(e, t) {
      ...
      function L() {
        for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++)
          t[n] = arguments[n];
        var i;
        "production" !== V.qA && (i = console).debug.apply(i, (0, r.Z)(t));
      }
      function U(e, t, n) {
        var r = document.createElement("a");
        (r.href = URL.createObjectURL(new Blob([e], { type: n }))),
          (r.download = t.replace(/["%*/:<>?\\|]/g, "_")),
          (r.target = "_blank"),
          r.click(),
          setTimeout(function () {
    ...
    5402: function (e, t, n) {
      ...
      function T(e) {
        return (function (e) {
          ...
          return (
            (t *= 60),
            void 0 !== e.alpha
              ? { hue: t, saturation: c, lightness: a, alpha: e.alpha }
              : { hue: t, saturation: c, lightness: a }
          );
        })(k(e));
      }
      var E = function (e) {
      ...
      function O(e, t, n) {
        ...
        if ("object" === typeof e && void 0 === t && void 0 === n)
          return I(e.hue, e.saturation, e.lightness);
        throw new f(1);
      }
      function D(e, t, n, r) {
        if (
          ...
          return r >= 1 ? I(e, t, n) : "rgba(" + p(e, t, n) + "," + r + ")";
        if (
          "object" === typeof e &&
          void 0 === t &&
          void 0 === n &&
      ...
      function N(e, t, n) {
        ...
        if ("object" === typeof e && void 0 === t && void 0 === n)
          return E("#" + A(e.red) + A(e.green) + A(e.blue));
        throw new f(6);
      }
      function M(e, t, n, r) {
      ...
      function L(e, t) {
        ...
        var n = T(t);
        return V((0, o.Z)({}, n, { hue: n.hue + parseFloat(e) }));
      }
      var U = P(L);
      function j(e, t, n) {
      ...
      function F(e, t) {
        ...
        var n = T(t);
        return V(
          (0, o.Z)({}, n, { lightness: j(0, 1, n.lightness - parseFloat(e)) })
        );
      }
      var z = P(F);
      function Z(e) {
      ...
      function q(e, t) {
        var n = Z(e),
          r = Z(t);
        return parseFloat(
          (n > r ? (n + 0.05) / (r + 0.05) : (r + 0.05) / (n + 0.05)).toFixed(2)
        );
      }
      function K(e, t) {
        if ("transparent" === t) return t;
      ...
      function G(e, t) {
        ...
        return M(
          (0, o.Z)({}, n, {
            alpha: j(0, 1, +(100 * r - 100 * parseFloat(e)).toFixed(2) / 100),
          })
        );
      }
      var Y = P(G);
      var J = n(4297),
        X = i()({ maxSize: 50 })(function (e, t) {
          try {
            return Y(e, t);
          } catch (n) {
            return (
              (0, J.H)(
                new Error("Error with color value " + t + " : " + n),
                !1
              ),
              "#ff0000"
            );
        ...
        te = i()({ maxSize: 50 })(function (e, t, n) {
          try {
            return W(e, t, n);
          } catch (r) {
            return (
              (0, J.H)(
                new Error("Error with color value " + t + " : " + r),
                !1
              ),
              "#ff0000"
            );
        ...
        ne =
          (i()({ maxSize: 50 })(function (e) {
            try {
              return (function (e) {
                if ("transparent" === e) return e;
                var t = T(e);
                return V((0, o.Z)({}, t, { hue: (t.hue + 180) % 360 }));
              })(e);
            } catch (t) {
              return (
                (0, J.H)(
                  new Error("Error with color value " + e + " : " + t),
                  !1
                ),
                "#ff0000"
              );
        ...
        re = i()({ maxSize: 50 })(function (e, t) {
          try {
            return q(e, t);
          } catch (n) {
            return (
              (0, J.H)(
                new Error("Error with color value " + e + " : " + n),
                !1
              ),
              0
            );
    ...
    3348: function (e, t, n) {
      ...
      var r = n(9343);
      "undefined" === typeof n.g.navigator &&
        (n.g.navigator = { userAgent: "test", maxTouchPoints: 0 });
      window.document,
        "undefined" !== typeof navigator &&
        "undefined" !== typeof navigator.userAgentData &&
        void 0 !== (0, r.Z)(navigator.userAgentData.platform)
          ? /mac|iphone|ipad|ipod/i.test(navigator.userAgentData.platform)
          : "undefined" !== typeof navigator &&
      ...
      var i = (function () {
        ...
        o =
          ("undefined" !== typeof navigator &&
          "undefined" !== typeof navigator.userAgentData &&
          void 0 !== (0, r.Z)(navigator.userAgentData.mobile)
          ...
          "undefined" !== typeof chrome &&
            ("runtime" in chrome || "webstore" in chrome)),
        s =
          ("undefined" !== typeof navigator &&
            "userAgent" in navigator &&
          ...
          (function () {
            ...
            if ("undefined" !== typeof navigator && "userAgent" in navigator) {
              ...
              if (e && e.length >= 3 && /chrome/i.test(e[1]))
                return Number.parseInt(e[2], 10);
            }
            return Number.NaN;
          })());
      Number.isNaN(s);
    ...
    9237: function (e, t, n) {
      ...
      function y(e) {
        var t, n, r;
        1 === e.storyContentVersion &&
          (null === (n = e.story) || void 0 === n || n.reconstructStory(),
          (e.storyContentVersion = 2));
        if (
          (void 0 === e.didGenerate &&
            (null !==
              (r =
                null === (t = e.story) || void 0 === t
                  ? void 0
                  : t.fragments.length) && void 0 !== r
              ? r
              : 0) > 2 &&
            (e.didGenerate = !0),
            ...
            for (
              var h,
                d = (
                  null !==
                    (o =
                      null === (i = e.story) || void 0 === i
                        ? void 0
                        : i.datablocks) && void 0 !== o
                    ? o
                    : []
                )[Symbol.iterator]();
              !(s = (h = d.next()).done);
              ...
              var p = h.value;
              p.endIndex < p.startIndex && (p.endIndex = p.startIndex),
                p.origin === f.Og.flattened &&
        ...
        if (e.storyContentVersion < 5) {
          var g,
            v = e.settings.parameters,
            y = (null === v || void 0 === v ? void 0 : v.logit_bias_groups)
              ? JSON.parse(
                  JSON.stringify(
                    null === v || void 0 === v ? void 0 : v.logit_bias_groups
                  )
                )
              : void 0;
          A(null !== y && void 0 !== y ? y : [], 0),
            (e.phraseBiasGroups = y),
            v.eos_token_id &&
              ((e.eosSequences = []),
              e.eosSequences.push(
                new c.W(new l.$N(v.eos_token_id.toString(), l.xI.GPT2Tokens))
              )),
            (e.bannedSequenceGroups = [
              C(null !== (g = v.bad_words_ids) && void 0 !== g ? g : []),
            ]),
            (e.storyContentVersion = 5);
        }
      ...
      function w(e) {
        if (
          (e.lorebookVersion < 3 && (e.lorebookVersion = 3),
          e.lorebookVersion < 4)
        ) {
          var t = !0,
            n = !1,
          ...
          try {
            for (
              var c, l = e.categories[Symbol.iterator]();
              !(s = (c = l.next()).done);
              s = !0
            ) {
                    ...
                    (f =
                      (f =
                        (f =
                          f &&
                          JSON.stringify(
                            null === (t = e.contextPresets) || void 0 === t
                              ? void 0
                              : t.contextDefaults[0]
                          ) === JSON.stringify((0, s.WR)())) &&
                        JSON.stringify(
                          null === (n = e.contextPresets) || void 0 === n
                            ? void 0
                            : n.contextDefaults[1]
                        ) === JSON.stringify((0, s.oX)())) &&
                      JSON.stringify(
                        null === (r = e.contextPresets) || void 0 === r
                          ? void 0
                          : r.storyDefault
                      ) === JSON.stringify((0, s.i_)())) &&
                    JSON.stringify(
                      null === (i = e.contextPresets) || void 0 === i
                        ? void 0
                        : i.loreDefaults[0].contextConfig
                    ) === JSON.stringify((0, s.xk)())) &&
                  !1 ===
                    (null === (o = e.contextPresets) || void 0 === o
                      ? void 0
                      : o.loreDefaults[0].forceActivation)) &&
                1e3 ===
                  (null === (u = e.contextPresets) || void 0 === u
                    ? void 0
                    : u.loreDefaults[0].searchRange)) &&
              !1 ===
                (null === (c = e.contextPresets) || void 0 === c
                  ? void 0
                  : c.loreDefaults[0].keyRelative)) &&
            !1 ===
              (null === (l = e.contextPresets) || void 0 === l
                ? void 0
                : l.loreDefaults[0].nonStoryActivatable)) &&
            (e.contextPresets = void 0),
            e.presetVersion;
        }
        e.presetVersion < 3 && (e.model = a.Ck.j6bv4),
          (e.parameters.logit_bias_groups = void 0),
          (e.parameters.eos_token_id = void 0),
          (e.parameters.bad_words_ids = void 0),
          E(e.parameters);
      }
      function k(e) {
        if (
          (void 0 === e.context[0].contextConfig &&
            (e.context[0].contextConfig = (0, s.WR)()),
          void 0 === e.context[1].contextConfig &&
            (e.context[1].contextConfig = (0, s.oX)()),
          e.scenarioVersion < 2)
        ) {
          var t,
            n = e.settings.parameters,
            r = (null === n || void 0 === n ? void 0 : n.logit_bias_groups)
              ? JSON.parse(JSON.stringify(n.logit_bias_groups))
              : void 0;
          A(null !== r && void 0 !== r ? r : [], 0),
            (e.phraseBiasGroups = r),
            n.eos_token_id &&
              ((e.eosSequences = []),
              e.eosSequences.push(
                new c.W(new l.$N(n.eos_token_id.toString(), l.xI.GPT2Tokens))
              )),
            (e.bannedSequenceGroups = [
              C(null !== (t = n.bad_words_ids) && void 0 !== t ? t : []),
            ]),
            (e.scenarioVersion = 2);
        }
      ...
      function T(e) {
        ...
        try {
          for (
            var i, o = e.scenarios[Symbol.iterator]();
            !(t = (i = o.next()).done);
            t = !0
          ) {
            k(i.value);
      ...
      function E(e) {
        if (
          (e.textGenerationSettingsVersion ||
            (e.textGenerationSettingsVersion = 1),
          e.textGenerationSettingsVersion <= 1)
        ) {
          var t = !0,
            n = !1,
          ...
          try {
            for (
              var i, o = e.order[Symbol.iterator]();
              !(t = (i = o.next()).done);
              t = !0
            ) {
              var s = i.value;
              0 === e.top_k && s.id === h.uv.TopK && (s.enabled = !1),
                1 === e.top_p && s.id === h.uv.TopP && (s.enabled = !1),
                1 === e.tail_free_sampling &&
                  s.id === h.uv.TFS &&
                  (s.enabled = !1);
            }
          } catch (a) {
        ...
        e.textGenerationSettingsVersion <= 2 &&
          (4 === e.order.length &&
            e.order.push(
              { id: h.uv.TopA, enabled: !1 },
              { id: h.uv.TypicalP, enabled: !1 }
            ),
      ...
      function A(e, t) {
        if (t < 1) {
          ...
          try {
            for (
              var o,
                s = (null !== e && void 0 !== e ? e : [])[Symbol.iterator]();
              !(n = (o = s.next()).done);
              n = !0
            ) {
              var a,
                u,
                c = o.value;
              (c.ensureSequenceFinish =
                null !== (a = c.ensure_sequence_finish) && void 0 !== a && a),
                (c.generateOnce =
                  null === (u = c.generate_once) || void 0 === u || u);
              var f = !0,
                h = !1,
                v = void 0;
              try {
                for (
                  var y, m = c.phrases[Symbol.iterator]();
                  !(f = (y = m.next()).done);
                  f = !0
                ) {
                  var b,
                    ...
                    S = y.value;
                  if (
                    S.type === l.xI.InterpretedString ||
                    S.type === l.xI.RawString
                  )
                    (S.sequence = (0, p.vB)(d._E.GPT2).decode(
                      null !==
                        (w =
                          null === (b = S.sequences) || void 0 === b
                            ? void 0
                            : b[0]) && void 0 !== w
                        ? w
                        : []
                      ...
                      S.type === l.xI.InterpretedString &&
                        (S.sequence = S.sequence.trimStart());
                  else if (S.type === l.xI.GPT2Tokens) {
                    var x, _;
                    S.sequence = (0, g.Kd)(
                      null !==
                        (_ =
                          null === (x = S.sequences) || void 0 === x
                            ? void 0
                            : x[0]) && void 0 !== _
                        ? _
                        : []
      ...
      function C(e) {
        for (
          var t = function () {
              var e = n[0],
                ...
                o = [],
                a = [],
                u = (0, p.vB)(d._E.GPT2).decode(e).trim().toLowerCase();
              if (u.length > 0) {
                var c = (function (e) {
                  var t = e.charAt(0).toUpperCase().concat(e.slice(1)),
                    n = e.toUpperCase(),
                    r = [
                      e,
                      " " + e,
                ...
                if (
                  ...
                  n.splice(0, c.length);
                  var l = (0, p.vB)(d._E.GPT2).decode(c[0]);
              ...
              try {
                for (
                  var v, y = e.entries()[Symbol.iterator]();
                  !(f = (v = y.next()).done);
                  f = !0
                ) {
                  var m = (0, i.Z)(v.value, 2),
                    b = m[0],
                    w = m[1],
                    S = (0, p.vB)(d._E.GPT2).decode([w]);
                  (0, p.vB)(d._E.GPT2).encode(S)[0] !== w
                    ? ((S = w.toString()), (a[b] = 1))
                    : (a[b] = 0),
                    t.push(S),
                    o.push(w);
        ...
        try {
          for (
            ...
            try {
              for (
                var k, T = b.displayMode[Symbol.iterator]();
                !(S = (k = T.next()).done);
                S = !0
              ) {
                var E = k.value;
    ...
    3008: function (e, t, n) {
      ...
      var r = n(25),
        i =
          ...
          n(19),
          {
            src: "static/_next/static/media/blue.dd1265a6.webp",
            height: 1,
            width: 1,
            blurDataURL:
              "data:image/webp;base64,UklGRjYAAABXRUJQVlA4ICoAAACQAQCdASoBAAEAAkA4JaACdLoAA5gA/vAM//na2GIMeH/ylfuy9JO5oAA=",
          });
      r.Ck.blue;
      var o;
      ...
      !(function (e) {
        (e[(e.True = 0)] = "True"),
          (e[(e.False = 1)] = "False"),
          (e[(e.OnSettingEnabled = 2)] = "OnSettingEnabled"),
          (e[(e.OnLowContext = 3)] = "OnLowContext"),
          (e[(e.OnEmptyContext = 4)] = "OnEmptyContext"),
          (e[(e.OnModule = 5)] = "OnModule"),
          (e[(e.OnAdventure = 6)] = "OnAdventure");
      })(o || (o = {}));
      var s,
        a,
        u = function (e, t) {
      ...
      o.OnEmptyContext,
        ...
        new Map([
          [
            (0, r.GN)(r.Ck.euterpev2),
            [
              f.adventureCondition,
              f.settingAndLowOrEmpty(l("***\n")),
              {
          ...
          [
            (0, r.GN)(r.Ck.krakev2),
            [f.adventureCondition, f.settingAndLowOrEmpty(l("<|endoftext|>"))],
          ],
          [
            (0, r.GN)(r.Ck.j6bv4),
            [f.adventureCondition, f.settingAndLowOrEmpty(l("\u2042\n"))],
          ],
    ...
    4118: function (e, t, n) {
      ...
      function i(e) {
        ...
        try {
          for (
            var o, s = Object.keys(e)[Symbol.iterator]();
            !(t = (o = s.next()).done);
            t = !0
          ) {
            var a = o.value;
    ...
    7044: function (e, t, n) {
      ...
      n(5416), n(6786), n(4297), n(5861).Buffer;
      var r = function (e, t) {
          return ((e % t) + t) % t;
        },
        i = new Set([
      ...
      function h(e, t, n) {
        ...
        try {
          for (
            var u, c = ['"', " ", "'", "\u2019"][Symbol.iterator]();
            !(o = (u = c.next()).done);
            o = !0
          ) {
            var l = u.value;
            (r = r.replace(new RegExp(l, "g"), "<|>" + l)),
              (i = i.replace(new RegExp(l, "g"), "<|>" + l));
          }
        } catch (w) {
          (s = !0), (a = w);
        } finally {
        ...
        for (
          var f = r.split("<|>").filter(Boolean),
            h = i.split("<|>").filter(Boolean),
            d = 0,
            p = 0,
            g = -1,
            v = -1,
            y = !1;
          d < h.length && p < f.length;

        ) {
          var m = f[p].toLowerCase(),
            b = h[d].toLowerCase();
          if (m.trim() === b.trim())
            g < 0 && (g = d), (v = d), (y = p === f.length), d++;
          else if (g > 0) break;
          p++;
        }
        return (
          g + v > -1 && h.splice(g, v - g + 1), n && !y ? t : h.join("").trim()
        );
      }
      var d = function (e) {
        var t = {};
            ...
            877: function (e, t, n) {
              ...
              function c(e, t, n) {
                ...
                if (
                  ...
                  (z(e, SharedArrayBuffer) ||
                    (e && z(e.buffer, SharedArrayBuffer)))
                )
                  return d(e, t, n);
                if ("number" === typeof e)
                  throw new TypeError(
                ...
                var i = (function (e) {
                  ...
                  if (void 0 !== e.length)
                    return "number" !== typeof e.length || Z(e.length)
                      ? a(0)
                      : h(e);
              ...
              function h(e) {
                for (
                  var t = e.length < 0 ? 0 : 0 | p(e.length), n = a(t), r = 0;
                  r < t;
                  r += 1
                )
                  n[r] = 255 & e[r];
              ...
              function m(e, t, n, r, i) {
                ...
                if (
                  ("string" === typeof t && (t = u.from(t, r)), u.isBuffer(t))
                )
              ...
              (t.kMaxLength = s),
                ...
                (u.concat = function (e, t) {
                  ...
                  for (n = 0; n < e.length; ++n) {
                    var o = e[n];
                    if ((z(o, Uint8Array) && (o = u.from(o)), !u.isBuffer(o)))
                      throw new TypeError(
                        '"list" argument must be an Array of Buffers'
                      );
      ...
      (r = function () {
        ...
        (e.configure = function (e) {
          ...
          (e.render = function (n) {
            ...
            var o,
              a = i.querySelector(t.barSelector),
        ...
        var o = (function () {
          ...
          s = (function () {
            ...
            function r(t) {
              ...
              if (t in n) return t;
              for (
                var r, i = e.length, o = t.charAt(0).toUpperCase() + t.slice(1);
                i--;
    ...
    8205: function (e, t, n) {
        ...
        map(e) {
          return g(
            this.contents
              ...
              .catch((t) => {
                if (s(t)) return t.then(() => this.map(e).contents);
                throw t;
              })
          );
        }
      ...
      function y(e) {
        const t = (function (e) {
          return e.every((e) => "hasValue" === e.state)
            ...
            : g(Promise.all(e.map((e) => e.contents)));
        })(
          (Array.isArray(e)
            ? e
      ...
      const V =
        ...
        B =
          null !== (D = r.useMutableSource) && void 0 !== D
            ? D
            : r.unstable_useMutableSource,
        P =
          null !== (N = r.useSyncExternalStore) && void 0 !== N
            ? N
      ...
      var Y = function (e, t, { error: n } = {}) {
        return null;
      };
      const { isFastRefreshEnabled: J } = L;
      class X {}
      const Q = new X(),
        ee = new Map(),
        te = new Map();
      ...
      var oe = {
        ...
        getNode: function (e) {
          const t = ee.get(e);
          if (null == t)
            throw new ne(`Missing definition for RecoilValue: "${e}""`);
          return t;
        },
        ...
        setConfigDeletionHandler: function (e, t) {
          M("recoil_memory_managament_2020") &&
            (void 0 === t ? re.delete(e) : re.set(e, t));
        },
          ...
          ((ae = function (e) {
            var t =
              ...
              p = function (e, t, n) {
                var r = n.length - 1,
                  ...
                  s = n;
                if (e) i = o = t;
                else for (s = new Array(r); i < t; ) s[o++] = n[i++];
                for (++i; i <= r; ) s[o++] = n[i++];
              ...
              S = function e(t, n, r, i, o, s) {
                ...
                return b(
                  t,
                  f(a) | f(u),
                  a === u ? [e(t, n + 5, r, i, o, s)] : a < u ? [i, s] : [s, i]
                );
              },
              x = function (e, t) {
                return e === t.edit;
              ...
              _ = function (e, t, n, r, i, o, s) {
                ...
                return c === a
                  ? this
                  : (++s.value, S(e, n, this.hash, this, i, y(e, i, o, c)));
              },
              ...
              T = function (e, t, n, r, i, s, a) {
                ...
                if (_ && v(T)) {
                  ...
                  (R |= m),
                    (C = (function (e, t, n, r) {
                      ...
                      for (var s = 0, a = 0, u = new Array(i + 1); s < t; )
                        u[a++] = r[s++];
                ...
                return A
                  ? ((this.mask = R), (this.children = C), this)
                  : b(e, R, C);
              },
              E = function (e, t, n, r, i, o, a) {
                ...
                return y
                  ? ((this.size = u), (this.children = m), this)
                  : w(e, u, m);
              };
            ...
            (g._modify = function (e, t, n, r, i, o, s) {
              ...
              (A.prototype.setTree = function (e, t) {
                return this._editable
                  ...
                  : e === this._root
                  ? this
                  : new A(this._editable, this._edit, this._config, e, t);
              });
            var R = (n.tryGetHash = function (e, t, n, r) {
              for (var i = r._root, o = 0, s = r._config.keyEq; ; )
                switch (i.type) {
                  case 1:
                  ...
                  case 2:
                    if (t === i.hash)
                      for (
                        var a = i.children, u = 0, c = a.length;
                        u < c;
                        ++u
                      ) {
                        var d = a[u];
            ...
            (n.make = function (e) {
              return new A(
                0,
                0,
                { keyEq: (e && e.keyEq) || N, hash: (e && e.hash) || c },
                g,
                0
              );
            }),
      ...
      var de = he,
        pe = Object.freeze({ __proto__: null, persistentMap: de });
      var ge = function (e, ...t) {
        const n = new Set();
        e: for (const r of e) {
          ...
          r !== u.currentTree.version &&
            ...
            r !==
              (null === (o = u.previousTree) || void 0 === o
                ? void 0
                : o.version) &&
            Y("Tried to save dependencies to a discarded tree");
      ...
      const { persistentMap: _e } = pe,
        { graph: ke } = me,
        { getNextTreeStateVersion: Te } = xe;
      function Ee() {
        const e = Te();
        return {
          version: e,
      ...
      const { getNode: Ne, getNodeMaybe: Me, recoilValuesForKeys: Ve } = oe,
        { RetentionZone: Be } = Ce,
        { setByAddingToSet: Pe } = Ie,
        ...
        const o = Ne(n),
          s = (function (e, t, n) {
            ...
            return () => {
              ...
              if (n instanceof Be) i(n);
              else if (Array.isArray(n)) for (const e of n) i(e);
            };
          })(e, n, o.retainedBy),
          a = o.init(e, t, r);
      ...
      function ze(e, t, n) {
        ...
        for (let a = i.pop(); a; a = i.pop()) {
          ...
          r.add(a);
          const e =
            null !== (s = o.nodeToNodeSubscriptions.get(a)) && void 0 !== s
              ? s
              : Le;
      ...
      var Ze = {
        getNodeLoadable: function (e, t, n) {
          return je(e, t, n, "get"), Ne(n).get(e, t);
        },
        peekNodeLoadable: Fe,
        setNodeValue: function (e, t, n, r) {
          const i = Ne(n);
          if (null == i.set)
            throw new Ue(`Attempt to set read-only RecoilValue: ${n}`);
          const o = i.set;
          ...
          return De(
            { type: o },
            {
              ...
              deps: () => {
                var e;
                return Ve(
                  null !== (e = i.nodeDeps.get(n)) && void 0 !== e ? e : []
                );
              },
              subscribers: () => {
                var i, o;
      ...
      const {
        ...
        { getNextComponentID: Ge } = xe,
        { getNode: Ye, getNodeMaybe: Je } = oe,
        { DefaultValue: Xe } = oe,
        { reactMode: Qe } = L,
        {
      ...
      function ot(e, t, n) {
        if ("set" === n.type) {
          const { recoilValue: r, valueOrUpdater: i } = n,
            s = (function (e, t, { key: n }, r) {
      ...
      function st(e, t, n) {
        "hasValue" === n.state && n.contents instanceof Xe
      ...
      function ht(e, t, n) {
        ut(e, { type: "set", recoilValue: t, valueOrUpdater: n });
      }
      var dt = {
        RecoilValueReadOnly: nt,
        AbstractRecoilValue: et,
        ...
        getRecoilValueAsLoadable: function (
          ...
          n.version !== o.currentTree.version &&
            n.version !==
              (null === (r = o.nextTree) || void 0 === r
                ? void 0
                : r.version) &&
            n.version !==
              (null === (i = o.previousTree) || void 0 === i
                ? void 0
                : i.version) &&
            Y("Tried to read from a discarded tree");
          const s = He(e, n, t);
        ...
        setRecoilValueLoadable: function (e, t, n) {
          ...
          ut(e, { type: "setLoadable", recoilValue: t, loadable: n });
        },
        markRecoilValueModified: function (e, t) {
          ut(e, { type: "markModified", recoilValue: t });
        },
        ...
        subscribeToRecoilValue: function (e, { key: t }, n, r = null) {
          ...
          o.nodeToComponentSubscriptions.has(t) ||
            ...
            a(o.nodeToComponentSubscriptions.get(t)).set(i, [
        ...
        applyAtomValueWrites: function (e, t) {
          ...
          return (
            t.forEach((e, t) => {
              "hasValue" === e.state && e.contents instanceof Xe
                ? n.delete(t)
                : n.set(t, e);
            }),
            n
      ...
      const { cleanUpNode: gt } = Ze,
        { deleteNodeConfigIfPossible: vt, getNode: yt } = oe,
        { RetentionZone: mt } = Ce,
        bt = new Set();
      function wt(e, t) {
        const n = e.getState(),
        ...
        const i = new Set();
        for (const s of t)
          if (s instanceof mt) for (const e of xt(n, s)) i.add(e);
          else i.add(s);
        const o = (function (e, t) {
          ...
          function u(t) {
            ...
            for (const e of l) {
              ...
              if (_t(e).some((e) => n.retention.referenceCounts.get(e))) {
                s.add(e);
                continue;
              }
            ...
            const h = new Set();
            for (const e of c)
              for (const t of null !== (d = i.nodeDeps.get(e)) && void 0 !== d
                ? d
                : bt) {
                var d;
                o.has(t) || h.add(t);
      ...
      function St(e, t, n) {
        ...
        for (const u of i) {
          var o;
          null === (o = r.retention.nodesRetainedByZone.get(u)) ||
            void 0 === o ||
            o.delete(n);
        }
        ...
        if (s) {
          ...
          if (void 0 !== e) {
            ...
            for (const t of e) {
              var a;
              null === (a = s.nodeToNodeSubscriptions.get(t)) ||
                void 0 === a ||
                a.delete(n);
            }
          }
      ...
      const { unstable_batchedUpdates: Et } = i;
      var At = { unstable_batchedUpdates: Et };
      const { unstable_batchedUpdates: Rt } = At;
      var Ct = { unstable_batchedUpdates: Rt };
      const { batchStart: It } = dt,
        { unstable_batchedUpdates: Ot } = Ct;
      let Dt = Ot;
      var Nt = {
        getBatcher: () => Dt,
        setBatcher: (e) => {
      ...
      const { batchUpdates: Ut } = Nt,
        { initializeNode: jt, peekNodeInfo: Ft } = Ze,
        { graph: zt } = me,
        { getNextStoreID: Zt } = xe,
        { DEFAULT_VALUE: qt, recoilValues: Kt, recoilValuesForKeys: $t } = oe,
        {
        ...
        { updateRetainCount: Jt } = Tt,
        { setInvalidateMemoizedSnapshot: Xt } = Ke,
        { getNextTreeStateVersion: Qt, makeEmptyStoreState: en } = Ae,
        { isSSR: tn } = Pt,
        { memoizeOneWithArgsHashAndInvalidation: nn } = Lt;
      class rn {
        constructor(e, t) {
          u(this, "_store", void 0),
            ...
            u(
              this,
              "getLoadable",
              (e) => (this.checkRefCount_INTERNAL(), Wt(this._store, e))
            ),
            u(
              this,
              "getPromise",
            ...
            u(this, "getNodes_UNSTABLE", (e) => {
              ...
              return null ==
                ...
                : !0 === e.isInitialized
                ? $t(Mt([t, n]))
                : Oe(Kt.values(), ({ key: e }) => !t.has(e) && !n.has(e));
            }),
            u(
              this,
              "getInfo_UNSTABLE",
              ({ key: e }) => (
                this.checkRefCount_INTERNAL(),
                Ft(this._store, this._store.getState().currentTree, e)
              )
            ),
            u(this, "map", (e) => {
              this.checkRefCount_INTERNAL();
          ...
          for (const n of this._store.getState().knownAtoms)
            jt(this._store, n, "get"), Jt(this._store, n, 1);
          this.autoRelease_INTERNAL();
        }
        retain() {
          this._refCount <= 0 &&
            Y("Attempt to retain() Snapshot that was already released."),
            this._refCount++;
          let e = !1;
          return () => {
            e || ((e = !0), this._release());
      ...
      function on(e, t, n = !1) {
        ...
        return {
          ...
          nodeCleanupFunctions: new Map(
            G(r.nodeCleanupFunctions.entries(), ([e]) => [e, () => {}])
          ),
        };
      }
      const [sn, an] = nn(
      ...
      const { getNextTreeStateVersion: mn, makeEmptyStoreState: bn } = Ae,
        {
          cleanUpNode: wn,
        ...
        { graph: Tn } = me,
        { cloneGraph: En } = me,
        { getNextStoreID: An } = xe,
        { createMutableSource: Rn, reactMode: Cn } = L,
        { applyAtomValueWrites: In } = dt,
      ...
      function zn(e) {
        ...
        if (null === t.nextTree) {
          M("recoil_memory_managament_2020") &&
            M("recoil_release_on_cascading_update_killswitch_2021") &&
            t.commitDepth > 0 &&
            On(e);
      ...
      const Zn = r.createContext({ current: jn }),
        qn = () => Mn(Zn),
      ...
      function Hn(e) {
        ...
        if (r.size) {
          for (const [n, i] of t.nodeTransactionSubscriptions)
            if (r.has(n)) for (const [t, r] of i) r(e);
          for (const [n, r] of t.transactionSubscriptions) r(e);
          (!Cn().early || t.suspendedComponentResolvers.size > 0) &&
            ($n(e, t, n),
      ...
      function Wn({ setNotifyBatcherOfChange: e }) {
        const t = qn(),
          [, n] = Ln([]);
        return (
          e(() => n({})),
              ...
              !(function (e) {
                ...
                try {
                  ...
                  (t.previousTree = t.currentTree),
                    ...
                    (t.previousTree = null),
                    M("recoil_memory_managament_2020") && null == n && On(e);
                } finally {
                  t.commitDepth--;
                }
              })(t.current);
      ...
      function Yn({
        ...
        const s = (e) => {
          ...
          u = (e, t) => {
            if (null == t) {
              const { transactionSubscriptions: t } = d.current.getState(),
                n = Gn++;
              return (
                t.set(n, e),
                {
            ...
            {
              const { nodeTransactionSubscriptions: n } = d.current.getState();
          ...
          c = (e) => {
            ...
            for (const t of Object.keys(e))
              a(d.current.getState().nextTree).transactionMetadata[t] = e[t];
          },
          l = (e) => {
            zn(d.current);
            ...
            n !== t &&
              ((o.current.nextTree = n),
              Cn().early && $n(d.current, o.current, n),
              a(f.current)());
          },
          f = Pn(null),
          h = Nn(
        ...
        const p = Bn(
          () =>
            null === Rn || void 0 === Rn
              ? void 0
              : Rn(o, () => o.current.currentTree.version),
          [o]
        );
        return (
          Vn(() => {
            const e = d.current;
            for (const t of new Set(e.getState().knownAtoms)) xn(e, t, "get");
            return () => {
          ...
          r.createElement(
            ...
            r.createElement(
              Kn.Provider,
              { value: p },
              r.createElement(Wn, { setNotifyBatcherOfChange: h }),
              i
            )
          )
        );
      ...
      const { useEffect: Qn, useRef: er } = r;
      var tr = function (e) {
        const t = er();
        return (
          Qn(() => {
      ...
      const { useStoreRef: nr } = Jn,
        { SUSPENSE_TIMEOUT_MS: rr } = Tt,
        { updateRetainCount: ir } = Tt,
        { RetentionZone: or } = Ce,
        { useEffect: sr, useRef: ar } = r,
        { isSSR: ur } = Pt;
      var cr = function (e) {
        if (M("recoil_memory_managament_2020"))
          return (function (e) {
            const t = (Array.isArray(e) ? e : [e]).map((e) =>
                e instanceof or ? e : e.key
              ),
              n = nr();
            sr(() => {
              if (!M("recoil_memory_managament_2020")) return;
              ...
              else for (const n of t) ir(e, n, 1);
              return () => {
            ...
            if (!ur && (void 0 === i || !Xn(i, t))) {
              const e = n.current;
              for (const n of t) ir(e, n, 1);
              if (i) for (const t of i) ir(e, t, -1);
      ...
      const { batchUpdates: fr } = Nt,
        { DEFAULT_VALUE: hr } = oe,
        { reactMode: dr, useMutableSource: pr, useSyncExternalStore: gr } = L,
        { useRecoilMutableSource: vr, useStoreRef: yr } = Jn,
        { isRecoilValue: mr } = H,
        {
      ...
      function Ir(e, t, n) {
        ...
        throw "hasError" === e.state
          ? e.contents
          : o(`Invalid value of loadable atom "${t.key}"`);
      }
      function Or(e) {
        const t = yr(),
          n = lr(),
          r = kr(() => {
            ...
            const r = t.current,
              i = r.getState(),
              o =
                dr().early && null !== (n = i.nextTree) && void 0 !== n
                  ? n
                  : i.currentTree;
            return { loadable: wr(r, e, o), key: e.key };
          }, [t, e]),
          i = kr((e) => {
            let t;
            return () => {
              ...
              return null !== (n = t) &&
                void 0 !== n &&
                n.loadable.is(i.loadable) &&
                (null === (r = t) || void 0 === r ? void 0 : r.key) === i.key
                ? t
                : ((t = i), i);
            };
          }, []),
          ...
          s = kr(
            (r) => {
              const i = t.current;
              return _r(i, e, r, n).release;
            },
            [t, e, n]
          );
        return gr(s, o, o).loadable;
      }
      function Dr(e) {
        const t = yr(),
          n = kr(() => {
      ...
      function Nr(e) {
        const t = yr(),
          ...
          i = kr(() => ({ loadable: r(), key: e.key }), [r, e.key]),
          o = kr(
            (e) => {
              const t = i();
      ...
      function Vr(e) {
        return (
          M("recoil_memory_managament_2020") && cr(e),
          {
      ...
      var jr = {
        ...
        useRecoilInterface: function () {
          ...
          return (
            Tr(() => {
              const n = t.current;
              ge(r.current, i.current).forEach((t) => {
                if (o.current.has(t))
                  return void W(`Double subscription to RecoilValue "${t}"`);
                ...
                ge(i.current, r.current).forEach((e) => {
                  s(e);
                }),
                (i.current = r.current);
            }),
          ...
          return (t, n = {}) => {
            fr(() => {
              e.current.addTransactionMetadata(n),
                t.forEach((t, n) => xr(e.current, new br(n), t));
            });
          };
        },
      ...
      const { batchUpdates: qr } = Nt,
        { DEFAULT_VALUE: Kr, getNode: $r, nodes: Hr } = oe,
        { useStoreRef: Wr } = Jn,
        { AbstractRecoilValue: Gr, setRecoilValueLoadable: Yr } = dt,
        { SUSPENSE_TIMEOUT_MS: Jr } = Tt,
        { cloneSnapshot: Xr } = pn,
        { useCallback: Qr, useEffect: ei, useRef: ti, useState: ni } = r,
        { isSSR: ri } = Pt;
      function ii(e) {
        const t = Wr();
        ei(() => t.current.subscribeToTransactions(e).release, [e, t]);
      }
      function oi(e) {
        const t = e.atomValues.toMap(),
          n = ve(
            Fr(t, (e, t) => {
              const n = $r(t).persistence_UNSTABLE;
            ...
            for (const t of e) {
              ...
              (null === (r = i.atomValues.get(t)) || void 0 === r
                ...
                (null === (s = o.atomValues.get(t)) || void 0 === s
                  ? void 0
                  : s.contents) &&
                $r(t).shouldRestoreFromSnapshots &&
                n.add(t);
            }
          n.forEach((t) => {
        ...
        useRecoilSnapshot: function () {
          ...
          if (
            ...
            if (i.current)
              window.clearTimeout(i.current),
                (i.current = null),
                null === (s = o.current) || void 0 === s || s.call(o),
                (o.current = null);
            (o.current = t.retain()),
      ...
      const { peekNodeInfo: ui } = Ze,
        { useStoreRef: ci } = Jn;
      var li = function () {
        const e = ci();
        return ({ key: t }) =>
          ui(e.current, e.current.getState().currentTree, t);
      };
      const { reactMode: fi } = L,
        { RecoilRoot: hi, useStoreRef: di } = Jn,
        { useMemo: pi } = r;
      var gi = function () {
        "MUTABLE_SOURCE" === fi().mode &&
          console.warn(
        ...
        return pi(
          () =>
            function ({ children: t }) {
              return r.createElement(hi, { store_INTERNAL: e }, t);
            },
          [e]
        );
      };
      const { loadableWithValue: vi } = R,
        { initializeNode: yi } = Ze,
        { DEFAULT_VALUE: mi, getNode: bi } = oe,
        {
          copyTreeState: wi,
      ...
      var Ei = function (e) {
        ...
        Ai = Ei,
        Ri = Object.freeze({ __proto__: null, atomicUpdater: Ai });
      var Ci = function (e, t) {
        if (!e) throw new Error(t);
      };
      const { atomicUpdater: Ii } = Ri,
        { batchUpdates: Oi } = Nt,
        { DEFAULT_VALUE: Di } = oe,
        { useStoreRef: Ni } = Jn,
        { refreshRecoilValue: Mi, setRecoilValue: Vi } = dt,
        { cloneSnapshot: Bi } = pn,
        { gotoSnapshot: Pi } = ai,
        { useCallback: Li } = r;
      class Ui {}
      ...
      const { useStoreRef: Zi } = Jn,
        { refreshRecoilValue: qi } = dt,
        { useCallback: Ki } = r;
      var $i = function (e) {
        const t = Zi();
        return Ki(() => {
      ...
      var Ji = class {
        ...
        Xi = Object.freeze({ __proto__: null, WrappedValue: Ji });
      const { isFastRefreshEnabled: Qi } = L;
      ...
      var to = class {
            ...
            const r = () => {
              ...
              for (const [t, p] of e) {
                ...
                if (
                  ...
                  "branch" !== a.type || a.nodeKey !== t)
                )
                  throw this.invalidCacheError();
                null === r || void 0 === r || r.branches.set(u, a),
                  null === n ||
                    void 0 === n ||
                    null === (l = n.onNodeVisit) ||
                    void 0 === l ||
                    l.call(n, a),
                  (u = this._mapNodeValue(p)),
                  (this._root =
                    null !== (f = this._root) && void 0 !== f ? f : a);
              }
              const h = a
                ? null === (r = a) || void 0 === r
                  ? void 0
                  : r.branches.get(u)
                : this._root;
              if (null != h && ("leaf" !== h.type || h.branchKey !== u))
                throw this.invalidCacheError();
              const d = { type: "leaf", value: t, parent: a, branchKey: u };
              null === (i = a) || void 0 === i || i.branches.set(u, d),
                (this._root =
                  null !== (o = this._root) && void 0 !== o ? o : d),
                this._numLeafs++,
                this._onSet(d),
                null === n ||
                  void 0 === n ||
          ...
          invalidCacheError() {
            ...
            throw (
              (Y(e + (null != this._name ? ` - ${this._name}` : "")), new eo())
            );
          }
        },
        no = Object.freeze({ __proto__: null, TreeCache: to });
      var ro = class {
          constructor(e) {
            var t;
          ...
          set(e, t) {
            ...
            const r = this.head(),
              i = { key: e, right: r, left: null, value: t };
            r ? (r.left = i) : (this._tail = i),
              this._map.set(n, i),
              (this._head = i),
              this._size++,
        ...
        io = Object.freeze({ __proto__: null, LRUCache: ro });
      const { LRUCache: oo } = io,
        { TreeCache: so } = no;
      var ao = function ({ name: e, maxSize: t, mapNodeValue: n = (e) => e }) {
        const r = new oo({ maxSize: t }),
          i = new so({
            name: e,
            mapNodeValue: n,
            onHit: (e) => {
      ...
      function uo(e, t, n) {
        ...
        switch (typeof e) {
          ...
          case "function":
            if (!0 !== (null === t || void 0 === t ? void 0 : t.allowFunctions))
              throw o("Attempt to serialize function in a Recoil cache key");
        ...
        if (Array.isArray(e))
          return `[${e.map((e, n) => uo(e, t, n.toString()))}]`;
        ...
        return e instanceof Set
          ? uo(
              Array.from(e).sort((e, n) => uo(e, t).localeCompare(uo(n, t))),
              t,
              n
            )
          : void 0 !== Symbol &&
          ...
          : `{${Object.keys(e)
              .filter((t) => void 0 !== e[t])
              .sort()
              .map((n) => `${uo(n, t)}:${uo(e[n], t, n)}`)
              .join(",")}}`;
      }
      var co = function (e, t = { allowFunctions: !1 }) {
        return uo(e, t);
      };
      const { TreeCache: lo } = no,
        fo = { equality: "reference", eviction: "keep-all", maxSize: 1 / 0 };
      var ho = function (
        {
        ...
        return (function (e, t, n, r) {
          switch (e) {
            case "keep-all":
              return new lo({ name: r, mapNodeValue: n });
            case "lru":
              return ao({ name: r, maxSize: a(t), mapNodeValue: n });
            case "most-recent":
              return ao({ name: r, maxSize: 1, mapNodeValue: n });
          }
          throw o(`Unrecognized eviction policy ${e}`);
        })(t, n, i, r);
      };
      const { isReactNative: po, isWindow: go } = Pt;
      var vo = {
      ...
      const {
        ...
        { WrappedValue: So } = Xi,
        { getNodeLoadable: xo, peekNodeLoadable: _o, setNodeValue: ko } = Ze,
        { saveDepsToStore: To } = me,
        {
          DEFAULT_VALUE: Eo,
        ...
        { isRecoilValue: Io } = H,
        { markRecoilValueModified: Oo } = dt,
        { retainedByOptionWithDefault: Do } = Tt,
        { recoilCallback: No } = zi,
        { startPerfBlock: Mo } = vo;
      class Vo {}
      const Bo = new Vo(),
        Po = [],
        Lo = new Map(),
      ...
      function jo(e) {
          ...
          return t
            .then((r) => {
              ...
              null != o.loadingDepKey && o.loadingDepPromise === t
                ? n.atomValues.set(o.loadingDepKey, wo(r))
              ...
              if (s && "loading" !== s.state) {
                if (
                  ((C(e, i) || null == A(e)) && m(e, i), "hasValue" === s.state)
                )
                  return s.contents;
                throw s.contents;
              }
        ...
        function _(e, i, u) {
          ...
          function _({ key: t }) {
            ...
            switch (
              (w.set(t, n),
              l ||
                (x(e, i, new Set(w.keys()), u),
                (function (e, t) {
                  C(e, t) && (a(A(e)).stateVersions.clear(), b(t, !1));
                })(e, u)),
              n.state)
            ) {
              case "hasValue":
              ...
              case "loading":
                throw (
                  ((m.loadingDepKey = t),
                  (m.loadingDepPromise = n.contents),
                  n.contents)
                );
            }
          ...
          const k =
            ...
            (...r) => {
              ...
              return null == t && Ci(!1), No(e, n, r, { node: t });
            };
          try {
            (d = r({ get: _, getCallback: k })),
              (d = Io(d) ? _(d) : d),
              yo(d) && ("hasError" === d.state && (v = !0), (d = d.contents)),
              s(d)
                ? (d = (function (e, t, n, r, i, o) {
                  ...
                  })(e, d, i, w, u, m).finally(h))
                : h(),
              (d = d instanceof So ? d.value : d);
          } catch (T) {
            (d = T),
              s(d) ? (d = S(e, d, i, w, u, m).finally(h)) : ((v = !0), h());
          }
          return (
            (g = v ? mo(d) : s(d) ? bo(d) : wo(d)),
            (l = !1),
            (function (e, t, n) {
              if (C(e, t)) {
                const t = A(e);
        ...
        function k(e, t) {
          ...
          try {
            r = l.get(
              (n) => ("string" !== typeof n && Ci(!1), xo(e, t, n).contents),
              {
                onNodeVisit: (e) => {
            ...
            throw o(
              `Problem with cache lookup for selector "${n}": ${a.message}`
            );
          }
          var s;
          r &&
            ...
            x(
              ...
              t,
              i,
              null === (s = A(e)) || void 0 === s ? void 0 : s.executionID
            ));
          return r;
        }
        function T(e, t) {
          ...
          if (null != r)
            return (
              "loading" ===
                (null === (i = r.loadingLoadable) || void 0 === i
                  ? void 0
                  : i.state) && w(e, r.executionID),
              r.loadingLoadable
            );
          const o = Uo(),
            [s, a] = _(e, t, o);
            ...
            "loading" === s.state
              ? (!(function (e, t, n, r, i) {
                  h.set(e, {
                    ...
                    executionID: t,
                    loadingLoadable: n,
                    stateVersions: new Map([[i.version, !0]]),
                  });
                })(e, o, s, a, t),
                w(e, o))
              : (R(e), I(t, s, a)),
        ...
        function E(e, t) {
          ...
          function r(n) {
            for (const [r, i] of n) if (!xo(e, t, r).is(i)) return !0;
            return !1;
          }
          for (const i of n) {
            if (
              i.stateVersions.get(t.version) ||
              !r(i.depValuesDiscoveredSoFarDuringAsyncWork)
            )
              return i.stateVersions.set(t.version, !0), i;
        ...
        function I(e, t, r) {
          ...
          try {
            ...
            throw o(
              `Problem with setting cache for selector "${n}": ${i.message}`
            );
          }
        }
        function O(e, t) {
          ...
          return null != r
            ...
            : l.get((n) => {
                var r;
                return (
                  "string" !== typeof n && Ci(!1),
                  null === (r = _o(e, t, n)) || void 0 === r
                    ? void 0
                    : r.contents
                );
              });
        ...
        function D(e, t) {
          return (function (e) {
            if (Po.includes(n)) {
              const e = `Recoil selector has circular dependencies: ${Po.slice(
                Po.indexOf(n)
              ).join(" \u2192 ")}`;
              return mo(o(e));
            }
          ...
          return (t = Co({
            ...
            set: (e, t, r) => {
              ...
              function l(n, r) {
                ...
                ko(e, t, n.key, s).forEach((e, t) => a.set(t, e));
              }
              const f = u(
                {
                  set: l,
              ...
              if (void 0 !== f)
                throw s(f)
                  ...
                  : o("Recoil: selector set should be a void function.");
              return (i = !0), a;
            },
            init: g,
            invalidate: N,
      ...
      const {
        ...
        { retainedByOptionWithDefault: is } = Tt,
        os = (e) => (e instanceof $o ? e.value : e);
      function ss(e) {
        const { key: t, persistence_UNSTABLE: n } = e,
          r = is(e.retainedBy_UNSTABLE);
        let i = 0;
        function u(e) {
          return qo(
            e
        ...
        function d(e, n) {
          var r, i;
          return null !==
            (r = null !== (i = n.atomValues.get(t)) && void 0 !== i ? i : c) &&
            void 0 !== r
            ? r
            : l;
        }
        const p = Jo({
          ...
          set: function (e, n, r) {
            if (n.atomValues.has(t)) {
              ...
              return new Map();
            return (c = void 0), new Map().set(t, Ko(r));
          },
          init: function (n, r, a) {
            var u;
            if ((i++, n.getState().knownAtoms.add(t), "loading" === l.state)) {
              const y = () => {
                var e;
            ...
            if (null != c) {
              ...
              function x(e) {
                if (b && e.key === t) {
                  ...
                  return e instanceof Go
                    ? d(n, r)
                    : s(e)
                    ? qo(e.then((e) => (e instanceof Go ? l.toPromise() : e)))
                    : Ko(e);
                }
                return es(n, e);
              }
              ...
              function k(e) {
                ...
                return !b || e.key !== t || m instanceof Go
                  ? i
                  : { ...i, isSet: !0, loadable: x(e) };
              }
              const T = (e) => (t) => {
                  if (b) {
                    const n = x(p),
                      r = "hasValue" === n.state ? n.contents : Wo;
                    (m = "function" === typeof t ? t(r) : t),
                      s(m) &&
                        (m = m.then((t) => ((S = { effect: e, value: t }), t)));
                  } else {
                    if (s(t))
                      throw o(
                ...
                A = (e) => (r) => {
                  ...
                  const { release: o } = n.subscribeToTransactions((n) => {
                    var i;
                    let { currentTree: o, previousTree: s } = n.getState();
                    s ||
                      (Y(
                      ...
                      (s = o));
                    const a =
                      null !== (i = o.atomValues.get(t)) && void 0 !== i
                        ? i
                        : l;
                    if ("hasValue" === a.state) {
                      var u, c, f, h;
                      const n = a.contents,
                        i =
                          null !== (u = s.atomValues.get(t)) && void 0 !== u
                            ? u
                            : l,
                        d = "hasValue" === i.state ? i.contents : Wo;
                      (null === (c = S) || void 0 === c ? void 0 : c.effect) !==
                        e ||
                      (null === (f = S) || void 0 === f ? void 0 : f.value) !==
                        n
                        ? r(n, d, !o.atomValues.has(t))
                        : (null === (h = S) || void 0 === h
                            ? void 0
                            : h.effect) === e && (S = null);
                    }
              ...
              if (((b = !1), !(m instanceof Go))) {
                ...
                const I = w
                        ...
                        const r = n
                          .then((n) => {
                            ...
                            return (
                              (null ===
                                (o = (
                                  null !== (i = e.getState().nextTree) &&
                                  void 0 !== i
                                    ? i
                                    : e.getState().currentTree
                                ).atomValues.get(t)) || void 0 === o
                                ? void 0
                                : o.contents) === r && ns(e, p, n),
                              n
                            );
                          })
                          .catch((n) => {
                  ...
                  : Ko(os(m));
                I.contents,
                  r.atomValues.set(t, I),
                  null === (g = n.getState().nextTree) ||
                    void 0 === g ||
                    g.atomValues.set(t, I);
              }
            }
            return () => {
              var e;
                    ...
                    void 0 === e.persistence_UNSTABLE
                      ...
                      : {
                          ...
                          validator: (t) =>
                            t instanceof Go
                              ? t
                              : a(e.persistence_UNSTABLE).validator(t, Wo),
                        },
                  effects: e.effects,
      ...
      var cs = class {
        ...
        ls = Object.freeze({ __proto__: null, MapCache: cs });
      const { LRUCache: fs } = io,
        { MapCache: hs } = ls,
        ds = { equality: "reference", eviction: "none", maxSize: 1 / 0 };
      var ps = function ({
        ...
        const r = (function (e) {
          ...
          i = (function (e, t, n) {
            switch (e) {
              case "keep-all":
                return new hs({ mapKey: n });
              case "lru":
                return new fs({ mapKey: n, maxSize: a(t) });
              case "most-recent":
                return new fs({ mapKey: n, maxSize: 1 });
            }
            throw o(`Unrecognized eviction policy ${e}`);
          })(t, n, r);
        return i;
      };
      const { setConfigDeletionHandler: gs } = oe;
      var vs = function (e) {
        var t, n;
        const r = ps({
          equality:
      ...
      const { setConfigDeletionHandler: ys } = oe;
      let ms = 0;
      var bs = function (e) {
        var t, n;
        const r = ps({
        ...
        return (t) => {
          ...
          try {
            ...
            throw o(
              `Problem with cache lookup for selector ${e.key}: ${f.message}`
            );
          }
          if (null != i) return i;
          const s = `${e.key}__selectorFamily/${
              null !== (n = co(t, { allowFunctions: !0 })) && void 0 !== n
                ? n
                : "void"
            }/${ms++}`,
            a = (n) => e.get(t)(n),
      ...
      function Ds(e, t, n) {
        return Os(
          e,
          n.map((e, n) => (null == e ? As(t[n]) : s(e) ? Es(e) : Ts(e)))
        );
      }
      var Ns = {
        waitForNone: bs({
      ...
      const { RecoilLoadable: Ms } = R,
        { DefaultValue: Vs } = oe,
        { RecoilRoot: Bs, useRecoilStoreID: Ps } = Jn,
        { isRecoilValue: Ls } = H,
        { retentionZone: Us } = Ce,
        { freshSnapshot: js } = pn,
        {
    ...
    6273: function (e, t, n) {
      ...
      function i(e, t) {
        ...
        if (!e) {
          ...
          throw (
            (console && o.length > 0 && console.log.apply(console, o),
            new Error("[serializr] " + (a || "Illegal State")))
          );
        }
      }
      function o(e) {
      ...
      function d(e) {
        if (e)
          return u(e)
            ...
            : u(e.serializeInfo)
            ? e.serializeInfo
            : e.constructor && e.constructor.serializeInfo
            ? e.constructor.serializeInfo
            : void 0;
      }
      function p(e, t) {
        return (
          i(u(t), "expected modelSchema, got " + t), (e.serializeInfo = t), t
        );
      }
      function g(e, t, n) {
        i(
          e !== Object,
          "one cannot simply put define a model schema for Object"
        ),
          i("function" === typeof e, "expected constructor function");
        var r = {
          targetClass: e,
          factory:
            n ||
      ...
      function v(e) {
        var t = {
          ...
          deserializer: function (e, t) {
            a(e)
              ? t(null, e)
              : t("[serializr] this value is not primitive: " + e);
          },
        };
        return (t = h(t, e));
      }
      var y = "undefined" !== typeof Symbol ? Symbol("SKIP") : { SKIP: !0 },
        m = v();
      function b(e, t) {
        i(
          1 === arguments.length || 2 === arguments.length,
        ...
        var o = r;
        return (
          o || i(o, "Failed to find default schema for " + e),
          Array.isArray(n)
            ? n.map(function (e) {
                return w(o, e);
              })
      ...
      function w(e, t) {
        var n;
        return (
          i(e && "object" === typeof e && e.props, "Expected schema"),
          i(t && "object" === typeof t, "Expected object"),
          (n = e.extends ? w(e.extends, t) : {}),
              ...
              if ("*" !== r) {
                ...
                !(function (e, t, n, r) {
                  for (var i = 0, o = Object.keys(n); i < o.length; i++) {
                    ...
                    if (
                      !(s in e.props) &&
                      (!0 === t || (t && (!t.pattern || t.pattern.test(s))))
                    ) {
                      var u = n[s];
                      if (!0 === t) a(u) && (r[s] = u);
                      else {
        ...
        x = (function () {
          function e(e, t, n, r, i) {
            (this.parentContext = e),
              ...
              (this.hasError = !1),
              e
                ? ((this.rootContext = e.rootContext), (this.args = e.args))
          ...
          return (
            (e.prototype.createCallback = function (e) {
              var t = this;
              return (
                ...
                (function (e) {
                  ...
                  n
                    ? t.hasError ||
                      ((t.hasError = !0), t.onReadyCb(n), S.delete(t))
                    : t.hasError ||
                      (e(r),
                      --t.pendingCallbacks === t.pendingRefsCount &&
                        (t.pendingRefsCount > 0
                          ? (t.onReadyCb(
                              new Error(
                                'Unresolvable references in json: "' +
                                  Object.keys(t.pendingRefs)
                                    .filter(function (e) {
                            ...
                            S.delete(t))
                          : (t.onReadyCb(null, t.target), S.delete(t))));
                })
              );
            }),
            (e.prototype.await = function (e, t, n) {
              if (
                (i(this.isRoot, "await can only be called on the root context"),
                t in this.resolvedRefs)
              ) {
              ...
              this.pendingRefsCount++,
                this.pendingRefs[t] || (this.pendingRefs[t] = []),
                this.pendingRefs[t].push({
                  modelSchema: e,
                  uuid: t,
                  callback: n,
                });
            ...
            (e.prototype.resolve = function (e, t, n) {
              if (
                (i(this.isRoot, "resolve can only called on the root context"),
                this.resolvedRefs[t] || (this.resolvedRefs[t] = []),
                this.resolvedRefs[t].push({ modelSchema: e, value: n }),
                t in this.pendingRefs)
              )
                for (var r = this.pendingRefs[t].length - 1; r >= 0; r--) {
                  var o = this.pendingRefs[t][r];
                  f(e, o.modelSchema) &&
                    (this.pendingRefs[t].splice(r, 1),
                    this.pendingRefsCount--,
                    o.callback(null, n));
                }
            }),
            (e.prototype.setTarget = function (e) {
              this.isRoot && this.target && S.delete(this.target),
                (this.target = e),
                S.set(this.target, this);
            }),
            (e.prototype.cancelAwaits = function () {
              i(
                this.isRoot,
                "cancelAwaits can only be called on the root context"
              );
              var e = this;
              Object.keys(this.pendingRefs).forEach(function (t) {
                e.pendingRefs[t].forEach(function (n) {
                  e.pendingRefsCount--,
                    n.callback(
                      new Error("Reference resolution canceled for " + t)
                    );
                });
              }),
                (this.pendingRefs = {}),
      ...
      function _(e, t, n, r) {
        void 0 === n && (n = o),
          i(arguments.length >= 2, "deserialize expects at least 2 arguments");
        var a = d(e);
        if (
          (i(u(a), "first argument should be model schema"), Array.isArray(t))
        ) {
          var c = [];
          return (
            s(
      ...
      function T(e, t, n, r) {
        ...
        for (
          var s = function (s) {
                      ...
                      if (
                        ...
                        !(function (e, t) {
                          for (var n in e.props) {
                            var r = e.props[n];
                            if ("object" === typeof r && r.jsonname === t)
                              return !0;
                          }
                          return !1;
                        })(t, s)
                        ...
                        !0 === n
                          ? (i(
                            ...
                            (r[s] = u))
                          : !n ||
                            (n.pattern && !n.pattern.test(s)) ||
                            n.deserializer(
                              u,
                              e.rootContext.createCallback(function (e) {
                                return e !== y && (r[s] = e);
                              }),
                              e
                            );
              ...
              i(
                "symbol" !== typeof c,
                "You must alias symbol properties. prop = %l",
                s
              );
              var l = n[c],
                f = u;
      ...
      var E = function (e, t, n, r, i, o) {
          o && "function" === typeof o.beforeDeserialize
            ? o.beforeDeserialize(e, t, n, r, i, o)
            : e(null, t);
        },
        A = function (e, t, n, r, i, o, s, a) {
          a && "function" === typeof a.afterDeserialize
            ? a.afterDeserialize(e, t, n, r, i, o, s, a)
            : e(t, n);
        };
      function R(e, t) {
        i(
        ...
        var n = {
          serializer: function (t) {
            return (
              i(u((e = d(e))), "expected modelSchema, got " + e),
              null === t || void 0 === t ? t : b(e, t)
            );
          },
          deserializer: function (t, n, r) {
            i(u((e = d(e))), "expected modelSchema, got " + e),
              null !== t && void 0 !== t ? k(r, e, t, n, void 0) : n(null, t);
          },
        };
        return (n = h(n, t));
      }
        ...
        var t = {
          serializer: function (e) {
            return null === e || void 0 === e
              ? e
              : (i(e instanceof Date, "Expected Date object"), e.getTime());
          },
          deserializer: function (e, t) {
      ...
      function I(e, t, n) {
        i("function" === typeof e, "first argument should be function"),
          i(
            "function" === typeof t,
      ...
      function O(e) {
        i(
          c((e = e && !0 !== e ? e : m)),
          "expected prop schema as second argument"
        );
        var t = e.serializer;
        i(
          "function" === typeof t,
      ...
      function D(e, t) {
        i(c((e = e || m)), "expected prop schema as first argument"),
          i(!l(e), "provided prop is aliased, please put aliases first");
        var n = {
          serializer: function (t) {
            return void 0 === t
              ? y
              : (i(
                  t && "length" in t && "map" in t,
          ...
          deserializer: function (t, n, r) {
            Array.isArray(t)
              ? s(
                  ...
                  function (n, i, o) {
                    function s(s, a) {
                      "function" === typeof e.afterDeserialize
                        ? A(i, s, a, n, t, o, r, e)
                        : i(s, a);
                    }
                    E(
    ...
    9964: function (e, t, n) {
      ...
      var a = function (e) {
          function t(e, r, u, c, h) {
            for (
              ...
              if (
                ...
                if (
                  B === F &&
                  (0 < P && (z = z.replace(f, "")), 0 < z.trim().length)
                ) {
                  switch (p) {
                    case 32:
                    case 9:
                ...
                switch (p) {
                  case 123:
                    for (
                      d = (z = z.trim()).charCodeAt(0), g = 1, U = ++B;
                      B < j;
                    ...
                    if (
                      ...
                      switch (
                        (0 < P && (z = z.replace(f, "")), (p = z.charCodeAt(1)))
                      ) {
                        case 100:
                        case 109:
                        case 115:
                      ...
                      if (
                        ((U = (g = t(r, P, g, p, h + 1)).length),
                        0 < N &&
                          ((w = a(3, g, (P = n(O, z, L)), r, R, A, U, p, h, c)),
                          (z = P.join("")),
                          void 0 !== w &&
                            0 === (U = (g = w.trim()).length) &&
                            ((p = 0), (g = ""))),
                  ...
                  case 59:
                    if (
                      1 <
                      (U = (z = (0 < P ? z.replace(f, "") : z).trim()).length)
                    )
                      switch (
                        (0 === M &&
                          ((d = z.charCodeAt(0)),
                        ...
                        0 < N &&
                          void 0 !==
                            (w = a(1, z, r, e, R, A, Z.length, c, h, c)) &&
                          0 === (U = (z = w.trim()).length) &&
                          (z = "\0\0"),
                        (d = z.charCodeAt(0)),
                        (p = z.charCodeAt(1)),
                ...
                case 10:
                  47 === _
                    ...
                    : 0 === 1 + d &&
                      ...
                      0 < z.length &&
                      ((P = 1), (z += "\0")),
                    0 < N * V && a(0, z, r, e, R, A, Z.length, c, h, c),
                    (A = 1),
                    R++;
                  break;
                case 59:
            ...
            if (0 < (U = Z.length)) {
              if (
                ((P = r),
                0 < N &&
                  void 0 !== (w = a(2, Z, P, e, R, A, U, c, h, c)) &&
                  0 === (Z = w).length)
              )
                return K + Z + q;
              if (((Z = P.join(",") + "{" + Z + "}"), 0 !== I * C)) {
                switch ((2 !== I || o(Z, 2) || (C = 0), C)) {
                  ...
                  case 112:
                    Z =
                      Z.replace(m, "::-webkit-input-$1") +
                      Z.replace(m, "::-moz-$1") +
                      Z.replace(m, ":-ms-input-$1") +
                      Z;
                }
                C = 0;
              }
              ...
              case 938:
                if (45 === s.charCodeAt(5))
                  switch (s.charCodeAt(6)) {
                    ...
                    case 115:
                      return (
                        "-webkit-" + s + "-ms-flex-item-" + s.replace(_, "") + s
                      );
                    default:
                      return (
                        "-webkit-" +
                        s +
                        "-ms-flex-line-pack" +
                        s.replace("align-content", "").replace(_, "") +
                        s
                      );
                  }
                break;
          ...
          function a(e, t, n, r, i, o, s, a, u, l) {
            for (var f, h = 0, d = t; h < N; ++h)
              switch ((f = D[h].call(c, e, d, n, r, i, o, s, a, u, l))) {
                case void 0:
                case !1:
                case !0:
                case null:
          ...
          function c(e, n) {
            ...
            return (
              0 < N &&
                void 0 !== (i = a(-2, o, r, r, R, A, o.length, 0, 0, 0)) &&
                (o = i),
              "",
              (C = 0),
              (A = R = 1),
      ...
      var E = (function () {
            ...
            if (s) {
              ...
              if (a) {
                var u = 0 | parseInt(a[1], 10),
                  c = a[2];
                0 !== u &&
                  (D(c, u), V(e, c, a[3]), e.getTag().insertRules(u, r)),
                  (r.length = 0);
              } else r.push(s);
            }
          }
        ...
        z = x,
        Z = { isServer: !x, useCSSOMInjection: !_ },
        q = (function () {
          function e(e, t, n) {
            void 0 === e && (e = y),
              void 0 === t && (t = {}),
      ...
      function te(e) {
        var t,
          ...
          p = function (e, r, o) {
            return (0 === r && -1 !== ee.indexOf(o[n.length])) || o.match(i)
              ? e
              : "." + t;
          };
        function g(e, o, s, a) {
      ...
      function ue(e) {
        ...
        return (
          ...
          i.createElement(
            ne.Provider,
            { value: a },
            i.createElement(re.Provider, { value: u }, e.children)
          )
        );
      }
      var ce = (function () {
      ...
      function pe(e) {
        return le.test(e) ? e.replace(fe, de).replace(he, "-ms-") : e;
      }
      var ge = function (e) {
        return null == e || !1 === e || "" === e;
      };
        ...
        return ge(e)
          ...
          ? (function e(t, n) {
              ...
              for (var s in t)
                t.hasOwnProperty(s) &&
                  !ge(t[s]) &&
                  ((Array.isArray(t[s]) && t[s].isCss) || m(t[s])
                    ? o.push(pe(s) + ":", t[s], ";")
                    : g(t[s])
      ...
      function Re(e) {
        ...
        for (var i = 0, o = n; i < o.length; i++) {
          var s = o[i];
          if (Te(s)) for (var a in s) Ee(a) && Ae(e, s[a], a);
        }
        return e;
      }
      ...
      function Ie(e) {
        ...
        return e.children
          ? i.createElement(Ce.Provider, { value: n }, e.children)
          : null;
      }
      var Oe = {};
      function De(e, t, n) {
        ...
        r &&
          ...
          (x = t.shouldForwardProp
            ...
            : e.shouldForwardProp);
        var _,
          k = new X(n, g, r ? e.componentStyle : void 0),
            ...
            return (function (e, t, n, r) {
              ...
              for (var T in _)
                "$" !== T[0] &&
                  ...
                  ("forwardedAs" === T
                    ? (k.as = _[T])
                    : (l ? l(T, c.Z, S) : !x || (0, c.Z)(T)) && (k[T] = _[T]));
              return (
                t.style &&
                  v.style !== t.style &&
                  (k.style = d({}, t.style, {}, v.style)),
        ...
        return (
          (E.displayName = p),
          ((_ = i.forwardRef(E)).attrs = S),
          (_.componentStyle = k),
          (_.displayName = p),
          (_.shouldForwardProp = x),
          (_.foldedComponentIds = r
            ? Array.prototype.concat(e.foldedComponentIds, e.styledComponentId)
            : v),
          (_.styledComponentId = g),
          ...
          (_.withComponent = function (e) {
            var r = t.componentId,
              ...
              o = r && r + "-" + (ke(e) ? e : xe(b(e)));
            return De(e, d({}, i, { attrs: S, componentId: o }), n);
          }),
      ...
      function Ve(e) {
        ...
        function c(e, t, n, r, i) {
          if (a.isStatic) a.renderStyles(e, k, n, i);
            ...
            var o = d({}, t, { theme: be(t, r, u.defaultProps) });
      ...
      !(function () {
        function e() {
          ...
          (this._emitSheetCSS = function () {
            ...
            (this.getStyleElement = function () {
              ...
              return (
                r && (n.nonce = r),
                [i.createElement("style", d({}, n, { key: "sc-0-0" }))]
              );
            }),
            (this.seal = function () {
              e.sealed = !0;
        ...
        (t.collectStyles = function (e) {
          return this.sealed
            ? T(2)
            : i.createElement(ue, { sheet: this.instance }, e);
        }),
    ...
    9168: function (e, t, n) {
      ...
      const a = [];
      for (let l = 0; l < 256; ++l) a.push((l + 256).toString(16).slice(1));
      function u(e, t = 0) {
        return (
          a[e[t + 0]] +
          a[e[t + 1]] +
      ...
      function u(e) {
        ...
        return (
          (u = function (e) {
            ...
            function i() {
              return s(e, arguments, (0, a.Z)(this).constructor);
            }
            return (
    ...
    5597: function (e, t, n) {
      ...
      class A {
        ...
        unpack(e, t) {
          if (i)
            return Q(
              () => (
                ee(),
                this ? this.unpack(e, t) : A.prototype.unpack.call(b, e, t)
              )
            );
          "object" === typeof t
            ? ((o = t.end || e.length), (s = t.start || 0))
            : ((s = 0), (o = t > -1 ? t : e.length)),
            (p = 0),
            (y = 0),
            (c = null),
            (d = a),
          ...
          try {
            ...
            throw new Error(
              "Source must be a Uint8Array or Buffer but was a " +
                (e && "object" == typeof e ? e.constructor.name : typeof e)
            );
          }
          if (this instanceof A) {
            if (((g = this), this.structures))
              return (u = this.structures), R(t);
            (!u || u.length > 0) && (u = []);
        ...
        unpackMultiple(e, t) {
          ...
          try {
            ...
            for (t(o); s < i; ) if (((r = s), !1 === t(R()))) return;
          } catch (Ve) {
        ...
        _mergeStructures(e, t) {
          ...
          for (let n in t || [])
            if (n >= 0) {
              ...
              i &&
                (r &&
                  ((e.restoreStructures || (e.restoreStructures = []))[n] = r),
                (e[n] = i));
            }
      ...
      function R(e) {
        try {
          ...
          let t;
          if (
            (g.randomAccessStructure && i[s] < 64 && i[s] >= 32 && x
              ? ((t = x(i, s, o, g)),
                (i = null),
                (e && e.lazy) || !t || (t = t.toJSON()),
                (s = o))
              : (t = I()),
            l && (s = l.postBundlePosition),
            s == o)
          )
            u && u.restoreStructures && C(),
              (u = null),
              (i = null),
              f && (f = null);
          else {
          ...
          throw (
            (u && u.restoreStructures && C(),
            ee(),
            (Ve instanceof RangeError ||
              Ve.message.startsWith("Unexpected end of buffer") ||
              s > o) &&
              (Ve.incomplete = !0),
            Ve)
          );
          ...
          switch (e) {
            ...
            case 193:
              return l
                ? ((t = I()),
                  t > 0
                    ? l[1].slice(l.position1, (l.position1 += t))
                    : l[0].slice(l.position0, (l.position0 -= t)))
                : S;
            case 194:
              return !1;
            case 195:
            ...
            case 213:
              return (
                (t = i[s]), 114 == t ? (s++, Y(63 & i[s++], i[s++])) : H(2)
              );
            case 214:
              return H(4);
            case 215:
            ...
            case 218:
              return (
                (t = h.getUint16(s)),
                y >= (s += 2) ? c.slice(s - v, (s += t) - v) : P(t)
              );
            case 219:
              return (
                (t = h.getUint32(s)),
                y >= (s += 4) ? c.slice(s - v, (s += t) - v) : L(t)
              );
            case 220:
          ...
          }
          {
            ...
            }
            {
              ...
              }
              {
                ...
                return (128 & y) > 0
                  ? void (s -= 15)
                  : z(t, n, r, o, a, u, c, l, f, h, d, p, g, v, y);
              }
            }
          }
        }
      ...
      function $(e) {
        return g.copyBuffers
          ? Uint8Array.prototype.slice.call(i, s, (s += e))
          : i.subarray(s, (s += e));
      }
      function H(e) {
        let t = i[s++];
      ...
      function G() {
        let e = i[s++];
        if (!(e >= 160 && e < 192)) return s--, I().toString();
        if (((e -= 160), y >= s)) return c.slice(s - v, (s += e) - v);
        if (!(0 == y && o < 180)) return V(e);
        let t,
          n = 4095 & ((e << 5) ^ (e > 1 ? h.getUint16(s) : e > 0 ? i[s] : 0)),
          r = W[n],
          a = s,
          u = s + e - 3,
          l = 0;
        ...
        for (r = [], W[n] = r, r.bytes = e; a < u; )
          (t = h.getUint32(a)), r.push(t), (a += 4);
        for (u += 3; a < u; ) (t = i[a++]), r.push(t);
        let f = e < 16 ? q(e) : Z(e);
        return (r.string = null != f ? f : V(e));
      }
      const Y = (e, t) => {
        let n = I().map((e) => e.toString()),
          r = e;
        void 0 !== t &&
        ...
        return (
          i &&
            i.isShared &&
            ((u.restoreStructures || (u.restoreStructures = []))[e] = i),
          (u[e] = n),
          (n.read = D(n, r)),
          n.read()
        );
      ...
      function Q(e) {
        ...
        return (
          ...
          (i = _),
          (T = C),
          (u = E).splice(0, u.length, ...A),
          (g = R),
          (h = new DataView(i.buffer, i.byteOffset, i.byteLength)),
          I
        );
      }
      function ee() {
      ...
      (m[98] = (e) => {
        ...
        (m[255] = (e) =>
          4 == e.length
            ? new Date(
                1e3 * (16777216 * e[0] + (e[1] << 16) + (e[2] << 8) + e[3])
              )
            : 8 == e.length
            ? new Date(
      ...
      class Se extends A {
        constructor(e) {
          ...
          let o = le.prototype.utf8Write
              ? function (e, t) {
                  return he.utf8Write(e, t, 4294967295);
                }
              : !(!oe || !oe.encodeInto) &&
                function (e, t) {
                  return oe.encodeInto(e, he.subarray(t)).written;
                },
            s = this;
          e || (e = {});
          ...
          this.pack = this.encode = function (e, o) {
            if (
              (he ||
                ((he = new ce(8192)),
                (pe = he.dataView = new DataView(he.buffer, 0, 8192)),
                (ye = 0)),
              (ge = he.length - 10),
              ge - ye < 2048
                ? ((he = new ce(he.length)),
                  (pe = he.dataView = new DataView(he.buffer, 0, he.length)),
                  (ge = he.length - 10),
                  (ye = 0))
                : (ye = (ye + 7) & 2147483640),
              (t = ye),
              (i = s.structuredClone ? new Map() : null),
            ...
            try {
              ...
              if ((me && Te(t, y, 0), i && i.idsToInsert)) {
                ...
                for (; u && n > 0; ) {
                  let i = e[--n].offset + t;
                  i < u.stringsPosition + t && -1 === r && (r = 0),
                    i > u.position + t
                      ? r >= 0 && (r += 6)
                      : (r >= 0 &&
                          (pe.setUint32(
                            u.position + t,
                            pe.getUint32(u.position + t) + r
                          ),
                          (r = -1)),
                        (u = u.previous),
                        n++);
              ...
              if (r) {
                ...
                if ((r.length > i && (r.length = i), g > 1e4))
                  (r.transitions = null),
                    (v = 0),
                    (g = 0),
                    p.length > 0 && (p = []);
                ...
                if (n && s.saveStructures) {
                  let n = he.subarray(t, ye),
                    o = Ae(r, s);
                  return !1 === s.saveStructures(o, o.isCompatible)
                    ? s.pack(e)
                    : ((s.lastNamedStructuresLength = i), n);
                }
              }
              o & Me && (ye = t);
            }
              ...
              if ("string" === r) {
                ...
                if (me && i >= 4 && i < 4096) {
                  if ((me.size += i) > 61440) {
                    let e,
                      n,
                      r = (me[0] ? 3 * me[0].length + me[1].length : 0) + 10;
                    ye + r > ge && (he = b(ye + r)),
                      me.position
                        ? ((n = me),
                          (he[ye] = 200),
                  ...
                  let n = be.test(e);
                  return (
                    (me[n ? 0 : 1] += e), (he[ye++] = 193), void y(n ? -i : i)
                  );
                }
                    ...
                    (o = e.charCodeAt(t)),
                      o < 128
                        ...
                        ? ((he[a++] = (o >> 6) | 192),
                          (he[a++] = (63 & o) | 128))
                        : 55296 === (64512 & o) &&
                          56320 === (64512 & (s = e.charCodeAt(t + 1)))
                ...
                n < 32
                  ? (he[ye++] = 160 | n)
                  : n < 256
                  ? (r < 2 && he.copyWithin(ye + 2, ye + 1, ye + 1 + n),
                    (he[ye++] = 217),
                    (he[ye++] = n))
                  : n < 65536
                  ? (r < 3 && he.copyWithin(ye + 3, ye + 2, ye + 2 + n),
                    (he[ye++] = 218),
                    (he[ye++] = n >> 8),
                    (he[ye++] = 255 & n))
                  : (r < 5 && he.copyWithin(ye + 5, ye + 3, ye + 3 + n),
                    (he[ye++] = 219),
                    pe.setUint32(ye, n),
                    (ye += 4)),
                  (ye += n);
                ...
                if (e >>> 0 === e)
                  ...
                  (e < 64 && !this.randomAccessStructure)
                    ...
                    ? ((he[ye++] = 205),
                      (he[ye++] = e >> 8),
                      (he[ye++] = 255 & e))
                    : ((he[ye++] = 206), pe.setUint32(ye, e), (ye += 4));
                else if (e >> 0 === e)
                  e >= -32
                    ? (he[ye++] = 256 + e)
                    : e >= -128
                    ? ((he[ye++] = 208), (he[ye++] = e + 256))
                    : e >= -32768
                    ? ((he[ye++] = 209), pe.setInt16(ye, e), (ye += 2))
                    : ((he[ye++] = 210), pe.setInt32(ye, e), (ye += 4));
                else {
                  let t;
                  if (
                    (t = this.useFloat32) > 0 &&
                  ...
                  if (r === Object) m(e, !0);
                    ...
                    (n = e.length) < 16
                      ...
                      ? ((he[ye++] = 220),
                        (he[ye++] = n >> 8),
                        (he[ye++] = 255 & n))
                      : ((he[ye++] = 221), pe.setUint32(ye, n), (ye += 4));
                    ...
                    (n = e.size) < 16
                      ...
                      ? ((he[ye++] = 222),
                        (he[ye++] = n >> 8),
                        (he[ye++] = 255 & n))
                      : ((he[ye++] = 223), pe.setUint32(ye, n), (ye += 4));
                    ...
                    for (let t = 0, n = se.length; t < n; t++) {
                      if (e instanceof ae[t]) {
                        ...
                        try {
                          r = n.pack.call(
                            ...
                            (e) => (
                              ...
                              (ye += e),
                              ye > ge && b(ye),
                              { target: he, targetView: pe, position: ye - e }
                            ),
                            y
                          );
                        } finally {
                        ...
                        return void (
                          r &&
                          (r.length + ye > ge && b(r.length + ye),
                          (ye = ke(r, he, ye, n.type)))
                        );
                      }
                    }
                ...
                if (
                  ...
                  (he[ye++] = 211), pe.setBigInt64(ye, e);
                else if (e < BigInt(1) << BigInt(64) && e > 0)
                  (he[ye++] = 207), pe.setBigUint64(ye, e);
                else {
              ...
              !1 === this.useRecords
                ? this.variableMapSize
                  ? (e) => {
                      ...
                      r < 16
                        ...
                        ? ((he[ye++] = 222),
                          (he[ye++] = r >> 8),
                          (he[ye++] = 255 & r))
                        : ((he[ye++] = 223), pe.setUint32(ye, r), (ye += 4));
                  ...
                  : (e, n) => {
                      ...
                      let i = 0;
                      for (let t in e)
                        (n || e.hasOwnProperty(t)) && (y(t), y(e[t]), i++);
                ...
                ? (e, n) => {
                    let i,
                      o,
                      s =
                        r.transitions || (r.transitions = Object.create(null)),
                      a = ye++ - t;
                    for (let u in e)
                      if (n || e.hasOwnProperty(u)) {
                        if (((i = s[u]), i)) s = i;
                          ...
                          for (let e = 0, t = n.length; e < t; e++) {
                            let t = n[e];
                            (i = s[t]),
                              i || ((i = s[t] = Object.create(null)), l++),
                              (s = i);
                          }
                          a + t + 1 == ye ? (ye--, w(s, n, l)) : S(s, n, a, l),
                            (o = !0),
                            (s = c[u]);
                        }
                        y(e[u]);
                    ...
                    s
                      ? s >= 96 && f
                        ? ((he[ye++] = 96 + (31 & (s -= 96))),
                          (he[ye++] = s >> 5))
                        : (he[ye++] = s)
                      : w(i, i.__keys__ || Object.keys(e), o);
            ...
            b = (e) => {
              ...
              if (e > 16777216) {
                ...
                n = Math.min(
                  ...
                  4096 *
                    Math.round(
                      Math.max((e - t) * (e > 67108864 ? 1.25 : 2), 4194304) /
                        4096
                    )
                );
              } else
                n = (1 + (Math.max((e - t) << 2, he.length - 1) >> 12)) << 12;
              let r = new ce(n);
              return (
                (pe = r.dataView = new DataView(r.buffer, 0, n)),
                (e = Math.min(e, he.length)),
                he.copy ? he.copy(r, 0, t, e) : r.set(he.slice(t, e)),
                (ye -= t),
                (t = 0),
                (ge = r.length - 10),
                (he = r)
            ...
            w = (e, t, i) => {
              ...
              o || (o = 64),
                ...
                !this.shouldShareStructure(t)
                  ? ((o = r.nextOwnId), o < d || (o = h), (r.nextOwnId = o + 1))
                  : (o >= d && (o = h), (r.nextId = o + 1));
                ...
                o < h
                  ...
                  : (s >= 0
                      ? ((he[ye++] = 213),
                        ...
                        (he[ye++] = 96 + (31 & o)),
                        (he[ye++] = s))
                      : ((he[ye++] = 212), (he[ye++] = 114), (he[ye++] = o)),
                    i && (g += v * i),
                    p.length >= l && (p.shift()[we] = 0),
                    p.push(e),
                    y(t));
            },
            S = (e, n, r, i) => {
              ...
              if (((he = o), (ye = s), (ge = a), (t = u), c > 1)) {
                ...
                e > ge && b(e);
                let n = r + t;
                he.copyWithin(n + c, n + 1, ye),
                  he.set(de.slice(0, c), n),
                  (ye = e);
              } else he[r + t] = de[0];
            },
            x = (e, i) => {
              let o = ve(
                ...
                (e, r, i) => {
                  ...
                  if (((ye = r), t > 0)) {
                    if ((y(e), 0 == t))
                      return { position: ye, targetView: pe, target: he };
                  } else y(e);
                  return ye;
                },
                this
        ...
        useBuffer(e) {
          (he = e),
            (pe = new DataView(he.buffer, he.byteOffset, he.byteLength)),
            (ye = 0);
        }
        clearSharedData() {
      ...
      function xe(e, t, n, r) {
        let i = e.byteLength;
        if (i + 1 < 256) {
          var { target: o, position: s } = n(4 + i);
          (o[s++] = 199), (o[s++] = i + 1);
        } else if (i + 1 < 65536) {
          var { target: o, position: s } = n(5 + i);
          (o[s++] = 200), (o[s++] = (i + 1) >> 8), (o[s++] = (i + 1) & 255);
        } else {
          var { target: o, position: s, targetView: a } = n(7 + i);
          (o[s++] = 201), a.setUint32(s, i + 1), (s += 4);
        }
        (o[s++] = 116),
          (o[s++] = t),
          o.set(new Uint8Array(e.buffer, e.byteOffset, e.byteLength), s);
      }
      function _e(e, t) {
        let n = e.byteLength;
        var r, i;
      ...
      function Te(e, t, n) {
        if (me.length > 0) {
          pe.setUint32(me.position + e, ye + n - me.position - e),
            (me.stringsPosition = ye - e);
          let r = me;
          (me = null), t(r[0]), t(r[1]);
        }
      }
        ...
        (se = [
            ...
            pack(e, t, n) {
              ...
              if (
                ...
                (n[o++] = 215),
                  ...
                  i.setUint32(
                    o,
                    4e6 * e.getMilliseconds() + ((r / 1e3 / 4294967296) >> 0)
                  ),
                  i.setUint32(o + 4, r);
              } else if (isNaN(r)) {
          ...
          },
          {
            pack(e, t, n) {
              ...
              this.moreTypes && ((i[o++] = 212), (i[o++] = 115), (i[o++] = 0)),
                n(r);
            },
          },
          {
          ...
          },
          {
            pack(e, t) {
              this.moreTypes
                ? xe(e, 16, t)
                : _e(ue ? ie.from(e) : new Uint8Array(e), t);
            },
          },
          {
            pack(e, t) {
    ...
    288: function (e, t, n) {
      ...
      function s(e, t, n, r) {
        for (let i = e.childCount, o = t.childCount; ; ) {
          ...
          let a = e.child(--i),
            ...
            c = a.nodeSize;
          if (a != u) {
            if (!a.sameMarkup(u)) return { a: n, b: r };
            if (a.isText && a.text != u.text) {
              ...
              for (
                ;
                e < t &&
                a.text[a.text.length - e - 1] == u.text[u.text.length - e - 1];
        ...
        textBetween(e, t, n, r) {
          ...
          return (
            this.nodesBetween(
              ...
              (s, a) => {
                s.isText
                  ? ((i += s.text.slice(Math.max(e, a) - a, t - a)), (o = !n))
                  : s.isLeaf
                  ? (r
                      ? (i += "function" === typeof r ? r(s) : r)
                      : s.type.spec.leafText && (i += s.type.spec.leafText(s)),
                    (o = !n))
                  : !o && s.isBlock && ((i += n), (o = !0));
              },
              0
      ...
      class d {
        ...
        removeBetween(e, t) {
          return new d(
            p(this.content, e + this.openStart, t + this.openStart),
            this.openStart,
            this.openEnd
          );
        }
        ...
        if (n.content.size) {
          if (n.openStart || n.openEnd || e.depth != r || t.depth != r) {
            let { start: i, end: s } = (function (e, t) {
              ...
              for (let i = n - 1; i >= 0; i--) r = t.node(i).copy(a.from(r));
              return {
      ...
      class O {
        ...
        hasMarkup(e, t, n) {
          return (
            this.type == e &&
            l(this.attrs, t || e.defaultAttrs || I) &&
            f.sameSet(this.marks, n || f.none)
          );
        }
        copy(e = null) {
        ...
        mark(e) {
          return e == this.marks
            ? this
            : new O(this.type, this.attrs, this.content, e);
        }
      ...
      class D extends O {
        ...
        toString() {
          return this.type.spec.toDebugString
            ...
            : N(this.marks, JSON.stringify(this.text));
        }
        get textContent() {
          return this.text;
        }
      ...
      function K(e) {
        let t = Object.create(null);
        if (e) for (let n in e) t[n] = new H(e[n]);
        return t;
      }
      class $ {
        constructor(e, t, n) {
          (this.name = e),
            ...
            (this.defaultAttrs = Z(this.attrs)),
        ...
        createChecked(e = null, t, n) {
          if (((t = a.from(t)), !this.validContent(t)))
      ...
      class G {
        constructor(e) {
          (this.cached = Object.create(null)),
            ...
            (this.nodes = $.compile(this.spec.nodes, this)),
            (this.marks = W.compile(this.spec.marks, this));
          let t = Object.create(null);
          for (let n in this.nodes) {
            ...
            let e = this.nodes[n],
              r = e.spec.content || "",
              i = e.spec.marks;
            (e.contentMatch = t[r] || (t[r] = M.parse(r, this.nodes))),
